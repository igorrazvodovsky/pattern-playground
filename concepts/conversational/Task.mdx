...
- [Agency](../?path=/docs/qualities-agency--docs): defines the system's capability to act independently and make decisions during task execution.

### Follow-ups

- <PatternRef slug="activities/bot">Bot</PatternRef>: interprets task specifications and executes work using available tools and capabilities.
- <PatternRef slug="activities/transparent-reasoning">Transparent reasoning</PatternRef>: makes the task execution process visible through step-by-step reasoning.
- <PatternRef slug="activities/activity-log">Activity log</PatternRef>: records task actions, progress, and outcomes for review and accountability.
- <PatternRef slug="activities/collaboration">Collaboration</PatternRef>: tasks serve as coordination scaffolding that structures collaborative work into manageable units.
