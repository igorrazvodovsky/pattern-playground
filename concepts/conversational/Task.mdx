...
- [Transparent reasoning](../?path=/docs/activities-transparent-reasoning--docs): makes the task execution process visible through step-by-step reasoning.
- [Activity log](../?path=/docs/activities-activity-log--docs): records task actions, progress, and outcomes for review and accountability.
