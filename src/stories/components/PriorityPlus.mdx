...
- [Toolbar](../?path=/docs/compositions-toolbar--docs) — the primary consumer. Priority+ makes toolbars responsive
- Priority+ is a way to handle [overflow](../?path=/docs/primitives-overflow--docs) for list-like components.
