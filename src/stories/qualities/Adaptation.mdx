...
Adjust system support based on user expertise and context. More guidance for novices (see [onboarding](../?path=/docs/activities-onboarding--docs)), more autonomy for experts (see [mastery](../?path=/docs/activities-mastery--docs)).
...
- Powers [bot](../?path=/docs/activities-bot--docs) interactions via probabilistic responses
- Underlies [suggestion](../?path=/docs/actions-application-suggestion--docs) and [explanation](../?path=/docs/actions-sensemaking-explanation--docs) patterns
- [Localization](../?path=/docs/foundations-localization--docs) — exercises adaptability across linguistic and cultural boundaries
{/* - [Focus and context](../?path=/docs/actions-evaluation-focus-and-context--docs) */}
