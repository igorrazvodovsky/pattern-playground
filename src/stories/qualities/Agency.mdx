...
### Relationship to intent lifecycle

The [intent lifecycle](../?path=/docs/foundations-intent-interaction--docs#intent-lifecycle) tracks *intent resolution state* — how clear and committed the actor's goal is at a given moment. Activity types track *what kind of work* is happening. The two axes cross freely: any lifecycle stage can involve any activity type, and agency shifts along both dimensions independently.
