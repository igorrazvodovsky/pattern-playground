...
<Meta title="Qualities/Conversation" />
...
- Relies on [temporality](../?path=/docs/qualities-temporality--docs). Conversation is an event-based process that unfolds over time.
