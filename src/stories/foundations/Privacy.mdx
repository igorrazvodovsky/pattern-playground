...
<Meta title="Foundations/Privacy" />
...
Privacy interacts with [agency](../?path=/docs/foundations-agency--docs) (who controls visibility), [collaboration](../?path=/docs/foundations-collaboration--docs) (balancing individual privacy with group transparency), and [shareability](../?path=/docs/foundations-shareability--docs) (what happens when state becomes public).
...
- Spatial arrangement of desks and surfaces provides surfaces for different privacy levels
...
- [Agency](../?path=/docs/foundations-agency--docs) — determines who controls visibility decisions and how control is distributed
...
- [Conversation](../?path=/docs/foundations-conversation--docs) — privacy affects audience awareness and appropriate disclosure in dialogue
- [Shareability](../?path=/docs/foundations-shareability--docs) — describes how state becomes public through sharing; privacy governs when that transition should occur
