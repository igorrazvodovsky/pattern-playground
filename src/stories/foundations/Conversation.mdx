...
Every interaction is a move in this ongoing conversation—actors coordinate action turn by turn.
Clicking a button isn't just triggering a function; it's making a request, offering a promise, or declaring completion.
