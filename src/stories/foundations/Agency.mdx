...
an interface and to actively guide the user. [Explanations](../?path=/docs/patterns-communication-explanation--docs), [suggestions](../?path=/docs/patterns-intelligence-suggestion--docs), or [dynamically
arranged sections](../?path=/docs/patterns-interaction-focus-and-context--docs) respond proactively, anticipating user needs and creating experiences that feel
