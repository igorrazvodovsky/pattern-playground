...
Agency patterns may shift across different contexts and stages. For example, in collaborative workflows, a system might operate reactively during initial input gathering, shift to co-operative during refinement, and become semi-active during final evaluation.
...
{/* - Guided input - Structured prompts, parameters, and multimodal input methods that shape system behaviour */}
{/* - Context management - Leveraging history, environment, task, and user information to inform system decisions */}
{/* - Transparency - Making system operations and reasoning visible and inspectable */}
{/* - Intervention - Direct modification, real-time adjustment, or rejection of system outputs */}
{/* - Adaptive scaffolding - Dynamic adjustment of assistance levels based on user needs and capabilities */}
{/* - Feedback loops - Iterative refinement through evaluation and correction cycles */}
