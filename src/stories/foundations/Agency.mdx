...
an interface and to actively guide the user. [Explanations](../?path=/docs/patterns-explanation--docs), [suggestions](../?path=/docs/patterns-intelligence-suggestion--docs), or [dynamically
