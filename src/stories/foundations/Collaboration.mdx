...
Effective collaboration depends on [conversation](../?path=/docs/foundations-conversation--docs) to build shared understanding and enable actors to surface goals, verify comprehension, and tune complexity through agreed protocols.
...
Managing these tensions requires deliberate design of conversational protocols and [agency](../?path=/docs/foundations-agency--docs) distribution.
...
- [Shareability](../?path=/docs/foundations-shareability--docs) – provides infrastructure for holopticism through URLs that capture and communicate precise application states
...
{/* - TODO: [Adaptation](../?path=/docs/foundations-adaptation--docs) */}
