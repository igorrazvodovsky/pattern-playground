...
The emergent ability of groups, whether composed of humans, or networks of humans and [bots](../?path=/docs/activities-bot--docs), to solve problems, make decisions, or generate knowledge more effectively than individual actors alone.
...
CI conditions map to [collaboration stages](../?path=/docs/activities-collaboration--docs#interaction-stages):
...
- [Annotation](../?path=/docs/actions-sensemaking-annotation--docs) — collective sense-making through shared markup and layered interpretation
- [Collaboration](../?path=/docs/activities-collaboration--docs) — interaction stages and variants for human↔human and human↔bot collaboration
- [Activity feed](../?path=/docs/activities-activity-feed--docs) – aggregation mechanism for distributed awareness
- [Formality](../?path=/docs/qualities-formality--docs) — shared artefacts raise formality demands beyond what any single actor needs; the fidelity vs exploration tension is a formality tension
