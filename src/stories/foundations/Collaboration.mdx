...
## TODO: Collective agency
Groups might behave like a single participant: a workgroup can hold goals, take action, and be perceived as a unit (a "we" with intent).
