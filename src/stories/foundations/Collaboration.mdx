...
- [Adaptability](../?path=/docs/qualities-adaptability--docs) — collaboration only works when each actor adjusts to the other's contributions in flight
- [Shareability](../?path=/docs/qualities-shareability--docs) — provides infrastructure for holopticism
