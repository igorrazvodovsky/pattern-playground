...
Intent resolution is conversational: each turn is a bid to advance resolution. [Conversation](../?path=/docs/qualities-conversation--docs) covers the cooperative principles; [Temporality](../?path=/docs/qualities-temporality--docs) covers rhythm and pacing. For multi-actor coordination, see [Collaboration](../?path=/docs/patterns-collaboration--docs).
