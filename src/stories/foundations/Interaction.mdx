...
- [Agency](../?path=/docs/qualities-agency--docs) asks who is driving at any given moment&nbsp;— including what the system contributes at each stage.
- [Activity types](../?path=/docs/qualities-agency--docs#agency-across-activity-types-and-intent-resolution) describe what kind of work is happening (perceiving, thinking, expressing, building, testing). The arc tracks *how committed the relationship is*; activity types track *what kind of work* is happening within it. The two axes cross freely — an actor whose relationship with the system is still forming may be expressing a query, perceiving results, and thinking about criteria within a single stage.
- [Temporality](../?path=/docs/qualities-temporality--docs) provides the rhythm and pacing of turn-taking.
