...
[Conversation](../?path=/docs/qualities-conversation--docs) as a paradigm implies interaction qualities—turn-based flow, and cooperation. Designing from a conversational point of view therefore grounds interaction as a shared, adaptive process where meaning is negotiated and trust is built turn by turn.
...
Following conversational [cooperation maxims](../?path=/docs/qualities-conversation--docs#cooperation), interaction design should:
