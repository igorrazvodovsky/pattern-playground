...
Present contextual content in a transient layer that appears on demand and dismisses itself when attention moves elsewhere.
...
When CSS anchor positioning will be supported by all browsers, a CSS-only solution can be tried.
