...
Reveal the actor's position in a hierarchy, enabling efficient backtracking and spatial orientation during [motivated movement](../?path=/docs/foundations-intent-interaction--docs#motivated-movement).
