...
- [Settings](../?path=/docs/actions-application-settings--docs) - Where global defaults are managed and overridden
...
- [Agency](../?path=/docs/qualities-agency--docs) — a default is the system making the small decision so the actor doesn't have to; the actor still has the final say but doesn't have to spend it on this field
- [Form](../?path=/docs/actions-application-form--docs) - The primary container where defaults are encountered
- [Input hints](../?path=/docs/actions-application-data-entry--docs#input-hints) - The alternative when a default cannot be guessed
- [Localization](../?path=/docs/foundations-localization--docs) — locale detection as a source of sensible defaults
