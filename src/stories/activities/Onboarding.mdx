...
- Delivery mechanisms: [Guided tours and overlays](../?path=/docs/activities-help--docs) introduce features without requiring pedagogic commands.
...
### Complementary
- [Help](../?path=/docs/activities-help--docs) – provides just-in-time assistance.
- [Localization](../?path=/docs/foundations-localization--docs) — first-run locale detection and selection
