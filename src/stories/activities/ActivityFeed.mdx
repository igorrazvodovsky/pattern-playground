...
<Meta title="Activities/Activity feed" tags={['activity-level:activity', 'atomic:pattern', 'role:pattern', 'mediation:networking']} />
...
- [Assistance](../?path=/docs/foundations-assistance--docs) — keeping recent events visible so the actor can notice what matters
- [Delegation](../?path=/docs/foundations-delegation--docs) — feed gives the user awareness of background agent activity
