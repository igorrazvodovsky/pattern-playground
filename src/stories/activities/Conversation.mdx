...
<Meta title="Activities/Conversation" tags={['activity-level:activity', 'atomic:pattern']} />
...
The [intent lifecycle](../?path=/docs/foundations-intent-interaction--docs#intent-lifecycle) provides temporal structure for extended conversations, while cooperation maxims ensure each turn respects actor agency and intent.
