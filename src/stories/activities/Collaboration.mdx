...
<Meta title="Activities/Collaboration" tags={['activity-level:activity', 'atomic:pattern', 'role:pattern', 'mediation:coordination']} />
...
Human-AI collaboration unfolds through the interaction stages with shifting [agency patterns](../?path=/docs/qualities-agency--docs#spectrum), [distribution](../?path=/docs/qualities-agency--docs#distribution), and [control mechanisms](../?path=/docs/qualities-agency--docs#control-patterns).
...
- Risk of [algorithmic loafing](../?path=/docs/activities-bot--docs#algorithmic-loafing)—reduced human effort when AI takes creative lead
...
- [Agency distribution](../?path=/docs/qualities-agency--docs#distribution): Human-centric locus enables deeper elaboration; system-centric locus often correlates with surface acceptance
...
Higher cognitive workload during collaboration correlates with increased perceived ownership and deeper elaboration (Maier et al. 2025).
Whilst reducing mental effort seems beneficial, appropriate cognitive load maintains skill development, creative engagement, and protection against algorithmic loafing.

#### Elaboration across [collaboration stages](#interaction-stages)
...
See [Conversation](../?path=/docs/activities-conversation--docs#dialogue-forms) for how dialogue forms shape elaboration in conversational interfaces, and [Bot](../?path=/docs/activities-bot--docs) for interaction patterns that maintain engagement.
...
### Qualities
- [Agency](../?path=/docs/qualities-agency--docs) — agency is distributed, traded, and renegotiated turn by turn; human-centric locus tends to deepen elaboration, system-centric locus tends to surface acceptance

### Precursors
- [Collaboration](../?path=/docs/foundations-collaboration--docs) – the foundation this activity enacts
- [Conversation](../?path=/docs/activities-conversation--docs) – how collaborators reach understanding and commitment
- [Bot](../?path=/docs/activities-bot--docs) – frames the AI as a collaborator with its own modes
- [LLM Prompt](../?path=/docs/activities-prompt--docs) – how humans address an AI participant

### Complementary
- [Activity log](../?path=/docs/activities-activity-log--docs) – the shared record that lets participants reconstruct what happened
- [Notification](../?path=/docs/actions-coordination-notification--docs) – signals what changed, by whom, and whether actor should look
- [Explanation](../?path=/docs/actions-sensemaking-explanation--docs) – how participants understand each other's reasoning, not just each other's actions
- [Suggestion](../?path=/docs/actions-application-suggestion--docs) – co-creation in tentative form: options participants can converge on or reject without commitment
- [Transparent reasoning](../?path=/docs/activities-transparent-reasoning--docs) – makes the basis of decisions auditable
- [Command menu](../?path=/docs/actions-seeking-command-menu--docs) – keeps collaboration commands accessible without crowding the surface
