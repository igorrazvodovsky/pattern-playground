...
- [Agency / appropriate reliance](../?path=/docs/qualities-agency--docs#appropriate-reliance) — visible reasoning is one of the strongest levers for reliance calibration, helping users judge when to trust vs override
