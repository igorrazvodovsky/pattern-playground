...
Preserving the reading position is one of the levers for [agency](../?path=/docs/qualities-agency--docs); the system shouldn't redirect the actor's attention without consent.
...
- [Bot](../?path=/docs/activities-bot--docs) — generates the stream that this surface presents in flight
...
- [Transparent reasoning](../?path=/docs/activities-transparent-reasoning--docs) — its "stream of thought" mode rides on the same rendering substrate
