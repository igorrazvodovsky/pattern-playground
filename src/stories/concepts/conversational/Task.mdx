...
- Task creation: Create a task, capture acceptance criteria and authority, and open the conversation
- Coordination establishment?
- Execution feedback
- Adaptive restructuring
- Task completion → seek acceptance (optional): when the fulfiller marks the task complete, don’t auto-close; prompt authority to accept or reject.
- Acceptance closes conversation; optional follow-ons: Authority declares accepted → conversation completes and can trigger the next step.
- Acceptance triggers notification to requester.
