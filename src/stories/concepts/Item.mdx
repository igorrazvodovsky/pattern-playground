...
Items can be rendered in multiple ways depending on user needs and interface constraints, from compact inline representations to detailed full-page views. See [Item view](../?path=/docs/patterns-item-view--docs) for the various rendering approaches.
...
- [Item view](../?path=/docs/patterns-item-view--docs) defines how items are rendered
