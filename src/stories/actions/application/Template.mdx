...
<Meta title="Actions/Application/Template" tags={['activity-level:action', 'atomic:pattern', 'role:pattern', 'lifecycle:application', 'mediation:individual']} />
...
- [Onboarding](../?path=/docs/activities-onboarding--docs): Templates as part of first-use or training
- [Wizards](../?path=/docs/actions-application-wizard--docs) and step-by-step builders: When templates are generated through choices
...
- `TODO:` Suggestion
- [Learnability](../?path=/docs/qualities-learnability--docs) — templates carry the shape of competent work, letting the actor learn the form by occupying it
