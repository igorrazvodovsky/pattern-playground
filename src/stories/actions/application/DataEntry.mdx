...
<Meta
  title="Actions/Application/Data entry"
...
- [Localization](../?path=/docs/foundations-localization--docs) — locale-aware input parsing and format tolerance
- [Input](../?path=/docs/operations-input--docs) - the basic component used.
- [Select](../?path=/docs/operations-select--docs) - picking one value from a short, bounded set when the actor already knows the answer.
- [Form](../?path=/docs/actions-application-form--docs) - the container for multiple data entry inputs.
- [Good defaults](../?path=/docs/operations-good-defaults--docs) - use when you can make a good guess to avoid data entry entirely.
- [Status feedback](../?path=/docs/operations-status-feedback--docs) - confirming the interpretation of forgiving input.
- [Bot](../?path=/docs/activities-bot--docs) - the agent often responsible for interpreting forgiving input.
- [Transparent reasoning](../?path=/docs/activities-transparent-reasoning--docs) - explaining *why* a specific interpretation was made.
- [Formality](../?path=/docs/qualities-formality--docs) — every data entry field is a choice about how formal the input has to be
