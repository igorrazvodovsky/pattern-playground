...
This approach is particularly effective when deletion is part of a larger editing session. See [Deletion](../?path=/docs/actions-application-deletion--docs) for detailed implementation examples.

## Related patterns

<div>
- [Deletion](../?path=/docs/actions-application-deletion--docs) – Save/cancel workflows as confirmation for destructive operations
