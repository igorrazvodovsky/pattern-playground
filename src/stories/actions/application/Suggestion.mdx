...
- [Assistance](../?path=/docs/foundations-assistance--docs) — providing likely next actions and narrowing the option space
- [Delegation](../?path=/docs/foundations-delegation--docs) — agent might suggest opportunities it believes will help
...
- [Adaptability](../?path=/docs/qualities-adaptability--docs) — suggestions might sharpen on the actor's accepted-or-rejected signal, fitting their patterns over time
- [Bot](../?path=/docs/activities-bot--docs)
...
- [Collaboration](../?path=/docs/activities-collaboration--docs) - Suggestions support collaborative decision-making through AI-assisted discovery
...
- [Formality](../?path=/docs/qualities-formality--docs) — suggestions ease the step from informal intent to formal expression, formalising by recognition rather than recall
- When suggestions carry real stakes, [cognitive forcing functions](../?path=/docs/actions-application-cognitive-forcing-functions--docs) offer interventions that preserve the user's judgement.
