...
<Meta title="Actions/Application/Settings" tags={['activity-level:action', 'atomic:pattern', 'role:pattern', 'lifecycle:application', 'mediation:individual']} />
...
Settings implement [agency](../?path=/docs/qualities-agency--docs) through configuration control, respect [privacy](../?path=/docs/qualities-privacy--docs) through visibility and access preferences, and enable [adaptability](../?path=/docs/qualities-adaptability--docs) by allowing actors to shape system behaviour to their contexts.
...
Individual actor preferences visible and modifiable only by that actor. These implement [privacy](../?path=/docs/qualities-privacy--docs) through individual control and don't require coordination.
...
## Settings as [onboarding](../?path=/docs/activities-onboarding--docs)

Settings can serve educational purposes beyond configuration. By organizing and documenting available capabilities, settings help actors understand what's possible.
This is particularly valuable in systems with extensive features that actors may not discover through normal usage.
...
### Precursors
- [Agency](../?path=/docs/qualities-agency--docs) – settings implement actor control over system behaviour
- [Privacy](../?path=/docs/qualities-privacy--docs) – settings include visibility and access preferences
- [Adaptability](../?path=/docs/qualities-adaptability--docs) – settings enable system customization to context

### Complementary
- [Progressive disclosure](../?path=/docs/actions-seeking-progressive-disclosure--docs) – manages complexity in extensive settings through hierarchical revelation
- [Form](../?path=/docs/actions-application-form--docs) – settings are essentially configuration forms requiring similar patterns (validation, feedback, submission)
- [Wizard](../?path=/docs/actions-application-wizard--docs) – may guide actors through initial settings configuration during setup
- [Onboarding](../?path=/docs/activities-onboarding--docs) – settings can be introduced gradually during first-time experience
- [AI tuning](../?path=/docs/activities-ai-tuning--docs) – specialized settings for configuring AI behaviour

### Follow-ups
- [Undo](../?path=/docs/operations-undo--docs) – enables reversal of settings changes, particularly valuable for exploratory configuration
- [Status feedback](../?path=/docs/operations-status-feedback--docs) – confirms settings changes and communicates their application
- [Notification](../?path=/docs/actions-coordination-notification--docs) – alerts actors to settings-related changes, particularly in shared configuration contexts
- [Localization](../?path=/docs/foundations-localization--docs) — language, timezone, and format preferences feed locale configuration

### Tangentially related
- [Workspace](../?path=/docs/activities-workspace--docs) – settings affect workspace behaviour and may be scoped to workspace contexts
- [Collaboration](../?path=/docs/activities-collaboration--docs) – settings include collaboration preferences and affect shared work
