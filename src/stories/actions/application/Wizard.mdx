...
- [Progressive disclosure](../?path=/docs/actions-seeking-progressive-disclosure--docs) - the conceptual foundation for revealing complexity gradually
...
- [Bot](../?path=/docs/activities-bot--docs) - can guide through complex processes with conversational flexibility wizards lack
...
- [Undo](../?path=/docs/operations-undo--docs) - mitigates the high commitment level by allowing reversal of completed steps
