...
While explicit hyperlinks and [references](../?path=/docs/operations-reference--docs) represent author-defined, deterministic connections,
dynamic hyperlinks add a configurable inference layer that discovers semantic relationships algorithmically.

When users select text, the system searches across available content to present contextually-
...
The implicit network of semantic connections is irreducibly dense—any sufficiently rich corpus contains countless valid relationships.
Dynamic hyperlinks acknowledge this by presenting algorithmic discoveries as *suggestions* and *exploration aids* rather than claims about "true" semantic structure.
This humility distinguishes them from explicit links, where actors commit to meaningful, curated connections.
...
- [References](../?path=/docs/operations-reference--docs) to typed entities
...
- [Agency](../?path=/docs/qualities-agency--docs) — User control over inferred connections

### Similar soft data patterns

- [Focus and Context](../?path=/docs/actions-evaluation-focus-and-context--docs) — Inferred component relationships and deduced missing elements
- [Suggestion](../?path=/docs/actions-application-suggestion--docs) — AI-suggested actions and connections

### Hard data counterparts

- [Reference](../?path=/docs/operations-reference--docs) — Explicit, typed entity linking (hard data layer)
- [Deep linking](../?path=/docs/operations-deep-linking--docs) — Deterministic URL-based addressability

### Complementary patterns

- [Progressive disclosure](../?path=/docs/actions-seeking-progressive-disclosure--docs) — Expand related content inline
- Hover cards — preview linked content without navigation
...
- [Notation](https://notation.linus.zone/)
{/* - [Semantic Text Networks](https://www.aaai.org/Papers/Symposia/Spring/2008/SS-08-07/SS08-07-005.pdf) */}
{/* - [Fluid Text Selection](https://arxiv.org/abs/2009.10979) */}