  ...
  render: () => (
    <div className="button-group">
      <pp-dropdown>
        ...
        <pp-list>
          <pp-list-item type="radio" defaultChecked onClick={action('sort-change')}>Sorting criteria 1</pp-list-item>
          <pp-list-item type="radio" onClick={action('sort-change')}>Sorting criteria 2</pp-list-item>
          <pp-list-item type="radio" onClick={action('sort-change')}>Sorting criteria 3</pp-list-item>
        </pp-list>
      </pp-dropdown>
