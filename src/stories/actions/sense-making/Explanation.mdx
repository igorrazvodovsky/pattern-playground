...
import { DynamicExplanation } from '../coordination/BubbleMenu.stories';

<Meta title="Actions/Sense-making/Explanation" tags={['activity-level:action', 'atomic:pattern', 'role:pattern', 'lifecycle:sense-making', 'mediation:individual']} />
...
Domain explanations transform system constraints from arbitrary-feeling to meaningful. They support [domain learnability](../?path=/docs/qualities-learnability--docs)—helping users understand the domain through the tool.
...
- [Learnability](../?path=/docs/qualities-learnability--docs) – domain explanations support domain learnability
- [Disabled state](./?path=/docs/operations-disabled-state--docs)
- [Progressive disclosure](../?path=/docs/actions-seeking-progressive-disclosure--docs)
- [Transparent reasoning](../?path=/docs/activities-transparent-reasoning--docs) – shows step-by-step process while explanation encourages understanding through interaction
- [Popover](./?path=/docs/operations-popover--docs)
- [Drawer](./?path=/docs/actions-application-drawer--docs)
- [Collaboration](../?path=/docs/activities-collaboration--docs) – uses explanations to facilitate understanding through transparency about other actors' actions
- [Localization](../?path=/docs/foundations-localization--docs) — culturally appropriate explanation styles
