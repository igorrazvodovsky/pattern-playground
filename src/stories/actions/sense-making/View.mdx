...
<Meta title="Actions/Sense-making/View" tags={['activity-level:action', 'atomic:composition', 'role:pattern', 'lifecycle:sense-making', 'mediation:individual']} />
...
- [Semantic zoom](../?path=/docs/actions-application-semantic-zoom--docs) for density-preserving transitions
...
- [Item view](../?path=/docs/actions-seeking-item-view--docs) - Single-entity representations across semantic levels
- [Data view](../?path=/docs/actions-seeking-data-view--docs) - Collection representations with filtering, sorting, and grouping
...
- [Malleability](../?path=/docs/qualities-malleability--docs) - The capability to change the view's content, layout, and composition
- [Semantic zoom](../?path=/docs/actions-application-semantic-zoom--docs) - Density-preserving transitions between framings
- [Progressive disclosure](../?path=/docs/actions-seeking-progressive-disclosure--docs) - Sequential revelation of information
- [Density](../?path=/docs/qualities-density--docs) - Information per unit of space
