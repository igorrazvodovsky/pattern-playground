...
### Supports
- [Transactional search](../?path=/docs/foundations-intent-interaction--docs#transactional-search) via [command menus](../?path=/docs/actions-seeking-command-menu--docs) and search
