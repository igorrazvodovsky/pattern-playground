...
<Meta title="Actions/Navigation/Hybrid patterns" tags={['activity-level:action', 'atomic:composition', 'role:pattern', 'lifecycle:seeking', 'mediation:individual']} />
...
[Wizard](../?path=/docs/actions-application-wizard--docs) is pure step by step—strict sequence, no jumping. This hybrid relaxes that constraint.
...
- [Navigation models](../?path=/docs/actions-navigation-overview--docs)
