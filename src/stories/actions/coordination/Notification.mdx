...
It's one of three ways to give [status feedback](../?path=/docs/operations-status-feedback--docs). Every notification has three parts: _purpose_, _type_, and _scope_.
