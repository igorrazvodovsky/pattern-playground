...
import { Callout } from '../../operations/Callout.stories';
import { DisruptiveNotification as Dialog } from '../application/Dialog.stories';
import { Notification as Toast } from '../../operations/Toast.stories';
import { MermaidDiagram } from '../../../components/MermaidDiagram';
import { profile } from './Notification.profile';

<Meta title="Actions/Coordination/Notification" tags={['activity-level:action', 'atomic:pattern', 'role:pattern', 'lifecycle:coordination', 'mediation:coordination']} />

> 🙂 **Fun meter: 3/5**. Included as a prerequisite for more interesting things.

# Notification

The delivery of system events to the actor's attention, balancing awareness against interruption. As one of three ways to give [status feedback](../?path=/docs/operations-status-feedback--docs), every notification has three parts: *purpose*, *type*, and *scope*.
...
### [Toast](../?path=/docs/operations-toast--docs)
...
### [Callout](../?path=/docs/operations-callout--docs)

Callouts are used to highlight important information contextually.

<Story of={Callout} />

### [Dialog](../?path=/docs/actions-application-dialog--docs)
...
- [Delegation](../?path=/docs/foundations-delegation--docs) — the primary communication channel for a background agent
- Part of the [status feedback](../?path=/docs/operations-status-feedback--docs) pattern system
- Complementary to validation and indication approaches
- [Collaboration](../?path=/docs/activities-collaboration--docs) – Notifications keep collaborators informed of changes and events in shared environments
