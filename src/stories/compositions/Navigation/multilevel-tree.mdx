...
- [Searching](../?path=/docs/compositions-searching--docs) — escape hatch when hierarchy fails
...
- Deep tree → multiple shallow trees or [searching](../?path=/docs/compositions-searching--docs)-first navigation
