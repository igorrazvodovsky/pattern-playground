...
- Pagination
- Representation: [Table](../?path=/docs/components-table--docs), [cards](../?path=/docs/compositions-card--docs), list, [timeline](../?path=/docs/components-timeline--docs), canvas, grid, calendar, gallery, kanban, gantt, the list goes on
