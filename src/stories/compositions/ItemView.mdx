...
**Full → collection:** Return to parent collection view ([data view](../?path=/docs/compositions-data-view--docs))
...
- [Card](../?path=/docs/compositions-card--docs) – summary-level item representations
