...
AI allows systems to handle the structure, accepting [forgiving input](../?path=/docs/patterns-data-entry--docs#forgiving-format) from the user.
...
Forms can be embedded in a [messaging](../?path=/docs/compositions-messaging--docs) interface, allowing for a more [conversational](../?path=/docs/patterns-conversation--docs) interaction.
...
- [Saving](../?path=/docs/patterns-data-operations-saving--docs) - autosave and manual save strategies

### Complementary
- [Callout](../?path=/docs/primitives-callout--docs) — inline validation and instructional feedback within forms
- [Good defaults](../?path=/docs/patterns-good-defaults--docs) - reduce friction by pre-selecting likely options
- [Details](../?path=/docs/primitives-details--docs) - collapsible form sections
- [Command menu](../?path=/docs/patterns-command-menu--docs) - quick access to form actions
- [Conversation](../?path=/docs/patterns-conversation--docs) may resolve into a form when a dialog stabilizes around well-structured data collection
