...
Forms can be embedded in a [messaging](../?path=/docs/compositions-messaging--docs) interface, allowing for a more [conversational](../?path=/docs/patterns-content-conversation--docs) interaction.
...
- [Mention](../?path=/docs/primitives-mention--docs) - Rich text input with @-mentions
*/}

### Follow-ups
- [Status feedback](../?path=/docs/patterns-communication-status-feedback--docs) - validation and system status communication
