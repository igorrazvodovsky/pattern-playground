...
User can delegate filtering to a [bot](../?path=/docs/patterns-bot--docs) via a TODO:task. Bot can have access to data beyond the attributes and values visible to the user.
