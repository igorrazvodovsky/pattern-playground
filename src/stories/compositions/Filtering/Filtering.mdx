...
Filtering allows an actor to add or remove [item](../?path=/docs/concepts-item--docs) from a displayed [collection](../?path=/docs/concepts-collection--docs) by turning on and off certain predefined attributes.
