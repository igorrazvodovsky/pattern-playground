...
## Settings as [onboarding](../?path=/docs/patterns-onboarding--docs)
...
- [Wizard](../?path=/docs/compositions-wizard--docs) – may guide actors through initial settings configuration during setup
...
- [Localization](../?path=/docs/patterns-localization--docs) — language, timezone, and format preferences feed locale configuration
