...
The [seek–use–share framework](../?path=/docs/foundations-behavior--docs) provides temporal structure for extended conversations, while cooperation maxims ensure each turn respects actor agency and intent.
