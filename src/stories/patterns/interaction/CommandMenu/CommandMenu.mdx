...
- [Embedded intelligence](../?path=/docs/patterns-intelligence-embedded-intelligence--docs) can help users find relevant commands when exact matches aren't available.

### Follow-ups

{/* - *Action history* may streamline repetitive workflows */}
- *Bookmarks*
- [Collaboration](../?path=/docs/patterns-interaction-collaboration--docs) - Command menus provide quick access to collaborative actions and workflows