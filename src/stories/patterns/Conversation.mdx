...
- Question-driven dialogue chains [agent inquiry](../?path=/docs/primitives-conversation-conversational-activities-inquiry-agent--docs) moves, where the agent asks questions to elicit human thinking
...
- All dialogue forms leverage [repair affordances](../?path=/docs/primitives-conversation-sequence-management-agent-repair--docs) and [sequence management](../?path=/docs/primitives-conversation-sequence-management-sequence-completion--docs) patterns to handle breakdowns and closures

These primitives provide the micro-level structure for conversations, whilst dialogue forms describe the macro-level strategic approach.
