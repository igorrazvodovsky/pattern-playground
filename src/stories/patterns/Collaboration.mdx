...
- Risk of [algorithmic loafing](../?path=/docs/patterns-bot--docs#algorithmic-loafing)—reduced human effort when AI takes creative lead
...
Human pivots core concept to serve different primary purpose, audience, or context—replacing the fundamental frame whilst leveraging AI input as inspiration.
...
- [Agency distribution](../?path=/docs/foundations-agency--docs#distribution): Human-centric locus enables deeper elaboration; system-centric locus often correlates with surface acceptance
...
See [Conversation](../?path=/docs/patterns-conversation--docs#dialogue-forms) for how dialogue forms shape elaboration in conversational interfaces, and [Bot](../?path=/docs/patterns-bot--docs) for interaction patterns that maintain engagement.
