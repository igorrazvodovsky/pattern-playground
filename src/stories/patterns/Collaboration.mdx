...
A process where multiple actors collectively evaluate options, share perspectives, and converge on choices through negotiation, consensus-building, or structured selection mechanisms.

#### Key characteristics
- Transparent reasoning: Decision criteria and rationale are visible to all participants
- Equal participation: All actors have meaningful opportunities to contribute their perspectives
- Conflict resolution: Clear mechanisms for handling disagreements and competing preferences
- Consensus-building: Structured approaches to finding common ground or acceptable compromises
- Accountability: Clear attribution of decisions and their outcomes

### Collaborative co-creation

A process where actors jointly produce something new by building on each other's contributions, resulting in emergent outcomes that couldn't be achieved individually.

#### Key characteristics
- Iterative refinement: Ideas and artefacts evolve through successive contributions
- Creative synthesis: Individual inputs combine to create novel solutions or insights
- Shared ownership: All contributors have stake in the final outcome
- Emergent properties: The collective result exhibits qualities beyond the sum of individual parts
- Build-on dynamics: Participants actively extend and transform each other's work
