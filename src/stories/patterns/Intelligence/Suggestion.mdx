...
<Meta title="Patterns/Intelligence/Suggestion*" />
...
- [Transparent reasoning](../?path=/docs/patterns-transparent-reasonining--docs) - suggestions can emerge from visible reasoning processes
