...
- [Explanation](../?path=/docs/patterns-communication-explanation--docs) - encourages understanding through interaction, while transparent reasoning shows the step-by-step process.
