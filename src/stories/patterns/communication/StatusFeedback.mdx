...
<Meta title="Patterns/Communication/Status feedback" />
...
## [Notification](../?path=/docs/patterns-communication-notification--docs)
...
- [Collaboration](../?path=/docs/patterns-interaction-collaboration--docs) – Status feedback provides awareness of system state and action effects in collaborative environments
