...
{/* - [Help](../?path=/docs/patterns-help--docs) - assistance and guidance */}
...
{/* - [Autofill](../?path=/docs/patterns-autofill--docs) - completing intent based on context */}
{/* - [Template](../?path=/docs/patterns-template--docs) - predefined structures for content creation */}
...
- [Mastery](../?path=/docs/patterns-mastery--docs) - supporting long-term skill acquisition
- [Dynamic hyperlinks](../?path=/docs/patterns-dynamic-hyperlinks--docs) - contextual navigation within content
{/* - [Semantic zoom](../?path=/docs/patterns-semantic-zoom--docs) - adjusting detail level based on context */}
{/* - [Relationship detection](../?path=/docs/patterns-relationship-detection--docs) - identifying connections between entities */}
{/* - [Temporal awareness](../?path=/docs/patterns-temporal-awareness--docs) - understanding and acting on time-based context */}
...
- [Tag](../?path=/docs/patterns-tag--docs) - collaborative categorization
{/* - [Checklist](../?path=/docs/patterns-checklist--docs) - tracking shared progress */}
...
Patterns for inputting information into the system. These patterns resolve the tension between the messiness of human expression and the system's need for structure.

- [Overview](../?path=/docs/patterns-data-entry-overview--docs) - philosophy of frictionless input
- [Forgiving Format](../?path=/docs/patterns-data-entry-forgivingformat--docs) - accepting diverse input formats
- [Structured Format](../?path=/docs/patterns-data-entry-structuredformat--docs) - enforcing rigid formats
- [Input Prompt](../?path=/docs/patterns-data-entry-inputprompt--docs) - instructing the user
- [Input Hints](../?path=/docs/patterns-data-entry-inputhints--docs) - guiding the user

## Managing outcomes

Handling the results of interaction. These patterns address the core tension between committing changes and maintaining safety, between action and reversibility.
...
- [Activity feed](../?path=/docs/patterns-activity-feed--docs) - aggregated stream of events
...
- [Settings](../?path=/docs/patterns-settings--docs) - configuration and preferences
- [Workspace](../?path=/docs/patterns-workspace--docs) - unified environment for tasks
- [Wizard](../?path=/docs/patterns-wizard--docs) - step-by-step guidance for complex tasks
{/* - [Synthesis](../?path=/docs/patterns-synthesis--docs) - restructuring and summarizing information */}
