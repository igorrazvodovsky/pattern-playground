...
– [Learnability](../?path=/docs/foundations-learnability--docs) – by observing *why* the system made a decision, users implicitly learn the system's logic and capabilities.
