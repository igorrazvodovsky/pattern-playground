...
## [Temporal](../?path=/docs/foundations-temporality--docs) dimension
...
### Precursors
- [Temporality](../?path=/docs/foundations-temporality--docs) – annotations are markers of time and wear.
- [Learnability](../?path=/docs/foundations-learnability--docs) – annotations provide the context needed for learning.
