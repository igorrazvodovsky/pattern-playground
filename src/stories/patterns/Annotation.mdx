...
### By permanence
- Persistent annotations: become part of the content's permanent context
- Ephemeral annotations: temporary marks that fade or expire
- Versioned annotations: track changes over time while preserving history

### By visibility
- Private annotations: personal notes visible only to the author
- Shared annotations: collaborative layer visible to specific groups
- Public annotations: open commentary accessible to all viewers
...
### Visual marking
Simple emphasis without/little semantic content—highlighting or color-coding.

### Textual annotation
Adding written commentary, notes, or descriptions that provide additional context or interpretation.
...
- [Commenting](../?path=/docs/patterns-commenting--docs) – extends annotation into discussion
...
{/* TODO: Replace */}
- [Collection](../?path=/docs/concepts-collection--docs) – gathering annotated fragments
