...
import * as LLMPromptStories from './LLMPrompt.stories.ts';
...
- voice
- image
- reference materials: both @mentiones and attachments
</div>

{/* Redo using blocks */}
{/* <Story of={ LLMPromptStories.StructuredPrompt } /> */}
...
- [Result](../?path=/docs/patterns-sullm-resultggestion--docs) – what (and how) user gets from the model.
</div>
