...
It's one of three ways to give [status feedback](../?path=/docs/patterns-statusfeedback--docs). Every notification has three parts: _purpose_, _type_, and _scope_.
...
- Part of the [Status feedback](../?path=/docs/patterns-statusfeedback--docs) pattern system
