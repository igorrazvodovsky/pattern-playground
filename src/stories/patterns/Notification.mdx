...
<Meta title="Patterns/Notification*" />
...
It's one of three ways to give [status feedback](../?path=/docs/patterns-status-feedback--docs). Every notification has three parts: _purpose_, _type_, and _scope_.
...
- Part of the [Status feedback](../?path=/docs/patterns-status-feedback--docs) pattern system
- Complementary to validation and indication approaches
- [Collaboration](../?path=/docs/patterns-interaction-collaboration--docs) – Notifications keep collaborators informed of changes and events in shared environments
