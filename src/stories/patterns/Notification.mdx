...
Communicating with users and providing feedback.

Notifications are comprised of _status_, _type_, and _scope_.
...
- Notification is one of the approaches to communicating [feedback]().
-
