...
- [Progressive disclosure](./?path=/docs/patterns-progressive-disclosure--docs)
- [Transparent reasoning](../?path=/docs/patterns-transparent-reasonining--docs) - shows step-by-step process while explanation encourages understanding through interaction
