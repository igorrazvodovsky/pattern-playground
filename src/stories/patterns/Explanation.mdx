...
Supporting contextualised learning by providing on-demand explanations for any selected content.
User can select any textual block and receive AI-generated explanation.
