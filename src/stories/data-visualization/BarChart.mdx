...
<Meta title="Data visualization/Bar chart" of = { BarChartStories } tags={['activity-level:operation', 'atomic:data-visualization', 'role:component', 'mediation:individual']} />
...
### Precursors
- [Data Tables](../?path=/docs/actions-evaluation-table--docs) - Tabular data that could be visualized

### Complementary
- Tooltip — used for hover interactions
- [Cards](../?path=/docs/actions-sensemaking-card--docs) - Chart containers

### Tangentially related
- [Sorting](../?path=/docs/actions-seeking-sorting--docs) - Data organization
- [Filtering](../?path=/docs/actions-seeking-filtering--docs) - Data subset selection
