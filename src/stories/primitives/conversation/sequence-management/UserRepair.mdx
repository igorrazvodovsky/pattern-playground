...
- [Extended telling](../?path=/docs/primitives-conversation-conversational-activities-extended-telling--docs) — fallback when a simple paraphrase or definition is insufficient
- [Sequence completion](../?path=/docs/primitives-conversation-sequence-management-sequence-completion--docs) — the activity resumes from the same step once the repair is resolved
