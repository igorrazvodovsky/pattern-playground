...
### Precursors
- [Temporality](/patterns/temporality) – annotations are markers of time and wear.
- [Learnability](/patterns/learnability) – annotations provide the context needed for learning.

### Follow-ups
- [Collaboration](/patterns/collaboration) – shared annotations enable collaborative sense-making.
- [Conversation](/patterns/conversation) – annotations often initiate critical dialogue.
- [Commenting](/patterns/commenting) – extends static annotation into dynamic discussion.

### Complementary
- [Explanation](/patterns/explanation) – clarifies complex concepts, often via description.
- [Transparent reasoning](/patterns/transparent-reasoning) – system annotations that reveal decision logic.
- [Generated content](/patterns/generated-content) – system marks confidence and origin.
- <ComponentRef id="primitives-reference--docs">Reference</ComponentRef> – citation and source tracking.
- [Tag](/patterns/tag) – semantic tagging for organisation.

### Tangentially related
- [Link preview](/patterns/link-preview) – previews can surface annotation layers attached to a linked destination
