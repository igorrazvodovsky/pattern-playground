...
relationships:
  related:
    - to: agency
      note: determines who controls visibility decisions and how control is distributed
    - to: conversation-quality
      note: privacy affects audience awareness and appropriate disclosure in dialogue
    - to: shareability
      note: describes how state becomes public through sharing; privacy governs when that transition should occur
---
