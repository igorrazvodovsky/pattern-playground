...
Privacy interacts with [agency](/patterns/agency) (who controls visibility), [collaboration](/patterns/collaboration-foundation) (balancing individual privacy with group transparency), and [shareability](/patterns/shareability) (what happens when state becomes public).
...
- [Agency](/patterns/agency) — determines who controls visibility decisions and how control is distributed
- [Collaboration](/patterns/collaboration-foundation) — requires balancing individual privacy needs with group transparency requirements
- [Conversation](/patterns/conversation-quality) — privacy affects audience awareness and appropriate disclosure in dialogue
- [Shareability](/patterns/shareability) — describes how state becomes public through sharing; privacy governs when that transition should occur
- [Data & Information](/patterns/data) — privacy affects what information can be perceived and by whom
- [Localization](/patterns/localization) — data residency and locale-specific regulation
