...
## Related patterns
- [Conversation](/patterns/conversation): Filter lenses implement the conversational maxims of manner and politeness by adapting tone and clarity for different contexts
...
- [Progressive disclosure](/patterns/progressive-disclosure): Lenses support revealing or concealing information based on user needs
- [Localization](/patterns/localization) — tone adjustment with cultural bounds
