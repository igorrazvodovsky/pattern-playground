...
- [Action consequences](/patterns/action-consequences) – Framework for evaluating appropriate confirmation methods
- [Saving](/patterns/saving) – Staged deletions within save/cancel workflows
- [Undo](/patterns/undo) – Reversibility and recovery mechanisms
- [Status feedback](/patterns/status-feedback) – Communicating deletion results
- [Activity Log](/patterns/activity-log) – Historical record of deletions
- [Notification](/patterns/notification) – Alerting about deletion events
- <ComponentRef id="components-action-bar--docs">Action bar</ComponentRef> – Common surface for bulk deletion
- [Selection](/patterns/selection) – How the scope of a deletion gets staked
