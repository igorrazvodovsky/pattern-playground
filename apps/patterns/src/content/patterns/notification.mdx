...
- [Delegation](/patterns/delegation) — the primary communication channel for a background agent
- Part of the [status feedback](/patterns/status-feedback) pattern system
- Complementary to validation and indication approaches
- [Collaboration](/patterns/collaboration) – Notifications keep collaborators informed of changes and events in shared environments
