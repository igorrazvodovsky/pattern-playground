...
Bot patterns embody different levels of system agency from the agency [spectrum](/patterns/agency#spectrum):
...
*Mitigation*: Design interactions where humans remain in creative or cognitive lead whilst bot provides scaffolding through questions, analogies, or contextual knowledge rather than complete solutions. See [Conversation](/patterns/conversation) dialogue forms for question-driven approaches that maintain engagement.
...
- [Assistance](/patterns/assistance) — chatbot and inline bot modes
- [Delegation](/patterns/delegation) — ambient and workflow automation bot modes
- [Agency](/patterns/agency) - how much freedom the bot has to act on its own.
- [Onboarding](/patterns/onboarding), priming, and [suggestions](/patterns/suggestion) are the first steps that help people get to know the bot—what it can and can't do, and how to get the most out of it.
- [Progressive disclosure](/patterns/progressive-disclosure) – bots often operate well with incremental complexity. Progressive disclosure keeps things simple at first and helps actors build confidence.

### Follow-ups

- Bot can use <ComponentRef id="actions-coordination-messaging--docs">messaging</ComponentRef> to [converse](/patterns/conversation) with actors.
- [Prompt](/patterns/prompt) describes ways of providing input to the bot.
- [Formality](/patterns/formality) – bots accept unstructured input by design; structure can be inferred or gradually formalised from interaction.
- LLM [settings](/patterns/ai-tuning) help keep users in control while the bot does its thing.
- [Generated content](/patterns/generated-content) - presentation and manipulation of AI's output.
- [Transparent reasoning](/patterns/transparent-reasoning) makes bot's decision-making process visible and inspectable.
- [Activity log](/patterns/activity-log) tracks bot actions and reasoning for transparency and review.
- [Collaboration](/patterns/collaboration) - Bots participate as collaborative agents with adaptable mediation capabilities
