...
- Focused: Bot as a primary interface, typically via <ComponentRef id="components-messaging--docs">messaging</ComponentRef>.
...
- Bot can use <ComponentRef id="components-messaging--docs">messaging</ComponentRef> to [converse](/patterns/conversation) with actors.
