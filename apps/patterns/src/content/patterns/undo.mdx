...
- Version history
- [Status feedback](/patterns/status-feedback): Provides immediate feedback on the undo action.
- [Command menu](/patterns/command-menu): Can be used to access undo options.
- [Activity log](/patterns/activity-log): Displays a history of actions that can be undone.
