...
<ComponentRef id="actions-coordination-messaging--docs">Messages</ComponentRef> or product <ComponentRef id="actions-sense-making-card--docs">cards</ComponentRef> can carry greater agency.
...
### [Activities](/patterns/activities)
Activities can adapt and reshape themselves strategically to construct the flow of
an interface and to actively guide the actor. [Explanations](/patterns/actions/sense-making/explanation), [suggestions](/patterns/actions/application/suggestion), or [dynamically
