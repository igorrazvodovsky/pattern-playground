...
relationships:
  ...
  enables:
    - to: filtering
      note: the constituent that turns a natural-language query into structured filters
    - to: focus-and-context
      note: the constituent that infers what contextual information is most relevant to the actor's current focus
  precedes:
    - to: suggestion
      note: the inference produces an offer — material the suggestion surface presents for the actor to accept, reject, or modify
---
