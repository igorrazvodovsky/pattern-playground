...
- [Command menu](/patterns/command-menu): A natural home for embedded intelligence, turning a simple command line into an intent-driven interface.
...
- [Suggestion](/patterns/suggestion): The output of embedded intelligence is often a suggestion that the user can accept, reject, or modify.
