...
- Patterns: free-text input, spatial canvas, <ComponentRef id="components-reference--docs">references</ComponentRef> without type requirements, <ComponentRef id="components-messaging--docs">messaging</ComponentRef>, [agent](/patterns/agent) interactions
