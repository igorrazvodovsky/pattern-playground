...
- Patterns: free-text input, spatial canvas, <ComponentRef id="primitives-reference--docs">references</ComponentRef> without type requirements, <ComponentRef id="components-messaging--docs">messaging</ComponentRef>, [bot](/patterns/bot) interactions
