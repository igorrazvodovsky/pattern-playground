...
- [Input](/patterns/primitives-input) - the basic component used.
- [Select](/patterns/primitives-select) - picking one value from a short, bounded set when the actor already knows the answer.
