...
If that fails, users can delegate filtering to a [bot](/patterns/activities/bot) via a task. Bot can have access to data beyond the attributes and values visible to the user.
