...
- <ComponentRef id="actions-coordination-action-bar--docs">Action bar</ComponentRef> — the primary consumer of multi-item selection; its existence is conditional on a selection existing
- <ComponentRef id="actions-coordination-bubble-menu--docs">Bubble menu</ComponentRef> — the primary consumer of content-range selection; spatially anchored to the selection
- <ComponentRef id="actions-application-context-menu--docs">Context menu</ComponentRef> — degenerate-case consumer; pointer-invoked on a single target
