...
The <ComponentRef id="actions-coordination-bubble-menu--docs">Bubble menu</ComponentRef> pattern demonstrates text lens application through text selection and transformation.
