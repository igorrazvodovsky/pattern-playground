...
### Complementary
- [Explanation](/patterns/actions/sense-making/explanation) – clarifies complex concepts, often via description.
...
- <ComponentRef id="primitives-reference--docs">Reference</ComponentRef> – citation and source tracking.
- [Tag](/patterns/actions/sense-making/tag) – semantic tagging for organisation.

### Tangentially related
- [Link preview](/patterns/actions/seeking/link-preview) – previews can surface annotation layers attached to a linked destination
- <ComponentRef id="primitives-badge--docs">Badge</ComponentRef> – visual indicators used as status annotations.
...
- [Badge](/patterns/primitives-badge) – visual annotation for status and categorical indicators
