...
- [Conversation](/patterns/conversation) — parent pattern; user inquiry appears across all dialogue forms
- [Bot repair](/patterns/agent-repair) — information capture via this primitive is used to resolve bot-side ambiguity
- [Extended telling](/patterns/extended-telling) — for multi-part answers that exceed the scope of a single inquiry response
