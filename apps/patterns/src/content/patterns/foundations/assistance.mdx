...
Assistance is a configuration of [agency](/patterns/qualities/agency) where the locus is human-centric, coupling is tight, granularity is fine-grained, and dynamics are typically static. The human drives the [interaction arc](/patterns/foundations/interaction#how-engagement-unfolds-over-time); the system intervenes selectively at each cognitive step — raising a signal, explaining something, narrowing the options, supporting execution, or helping the user look back at what just happened.
...
- Assistance sits on the [Intent & Interaction](/patterns/foundations/interaction) substrate and is the sibling configuration to [Delegation](/patterns/foundations/delegation)
