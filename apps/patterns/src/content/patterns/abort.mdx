...
- [Undo](/patterns/undo) — related non-destructive exit; offer undo and restore affordances when state has been modified
- [Closing](/patterns/closing) — the clean alternative when a session ends intentionally rather than by abandonment
- [Opening (Bot)](/patterns/agent-opening) — abort can occur immediately after a bot-initiated opening
- [Opening (User)](/patterns/user-opening) — abort can occur immediately after a user-initiated opening