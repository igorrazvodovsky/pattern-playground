...
The exposure of a [bot's](/patterns/bot) reasoning process as a legible trail of steps and decisions, transforming opaque computation into something the actor can inspect, trust, and challenge over time.
...
- [Learnability](/patterns/learnability) — by observing *why* the system made a decision, the actor implicitly learns its logic and capabilities
- [Agency](/patterns/agency) — visible reasoning is one of the levers for reliance calibration, helping the actor judge when to trust and when to override

### Precursors

- [Bot](/patterns/bot) - generates the reasoning that transparent reasoning makes visible and inspectable.

### Follow-ups

- [Activity log](/patterns/activity-log) - records the reasoning steps for review and audit.

### Complementary

- [Assistance](/patterns/assistance)
- [Delegation](/patterns/delegation)
- [Explanation](/patterns/explanation) - encourages understanding through interaction, while transparent reasoning shows the step-by-step process.
...
- [Suggestions](/patterns/suggestion) - can emerge from the visible reasoning process.
- [Collaboration](/patterns/collaboration) - Transparent reasoning makes AI decision-making processes inspectable for human collaborators
...
- [Cognitive forcing functions](/patterns/cognitive-forcing-functions) — counterbalancing interventions when transparent reasoning slides into over-reliance
