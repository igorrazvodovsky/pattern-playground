...
relationships:
  ...
  complements:
    - to: bot
      note: "gives the workflow-automation bot mode its procedure — the bot runs it, this artifact shows and edits it"
    - to: ai-tuning
      note: "a workflow builder is a tuning tool: editing the procedure is one of the ways a bot's behaviour gets progressively shaped"
  tangential:
    - to: wizard
...
- Route [AI tuning](/patterns/ai-tuning)'s skeletal Workflow section and [bot](/patterns/bot)'s workflow-automation mode here instead of restating
