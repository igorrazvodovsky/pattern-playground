...
- [Agency](/patterns/agency) — User control over data layer configuration
- [Adaptability](/patterns/adaptation) — Soft layers enable probabilistic adaptation
- [Conversation](/patterns/conversation-quality) — Turn-taking between user input and system responses
