...
- [Onboarding](/patterns/onboarding): Templates as part of first-use or training
- [Wizards](/patterns/wizard) and step-by-step builders: When templates are generated through choices
...
- [Learnability](/patterns/learnability) — templates carry the shape of competent work, letting the actor learn the form by occupying it
