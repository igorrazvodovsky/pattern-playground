...
- [Command menu](/patterns/command-menu) provides rapid access to workspaces and contexts without navigating interface hierarchy.

### Follow-ups
- [Activity log](/patterns/activity-log) shows history within a workspace.
