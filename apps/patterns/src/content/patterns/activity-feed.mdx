...
- [Assistance](/patterns/assistance) — keeping recent events visible so the actor can notice what matters
- [Delegation](/patterns/delegation) — feed gives the user awareness of background agent activity
- [Activity log](/patterns/activity-log) – distinct from feeds; logs are histories of _actions taken by_ an entity, whilst feeds aggregate content _of interest to_ users from diverse sources
- [Collaboration](/patterns/collaboration) – uses feeds to surface updates and changes in shared workspaces
- [Notification](/patterns/notification) – alerts users to new feed activity requiring attention
- <ComponentRef id="actions-coordination-messaging--docs">Messaging / Comment thread</ComponentRef> – enable [conversations](/patterns/conversation) around feed items
