...
relationships:
  complements:
    - to: assistance
      note: keeping recent events visible so the actor can notice what matters
    - to: delegation
      note: feed gives the user awareness of background agent activity
    - to: activity-log
...
- <ComponentRef id="actions-coordination-messaging--docs">Messaging / Comment thread</ComponentRef>
