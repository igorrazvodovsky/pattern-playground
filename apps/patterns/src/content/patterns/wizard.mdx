...
### Alternatives
- [Conversational form](/patterns/form#conversational-forms): Embeds form inputs within <ComponentRef id="actions-coordination-messaging--docs">messaging</ComponentRef> interface, allowing flexible dialogue whilst collecting structured data. Better for actors who benefit from clarifying questions.
