...
### Precursors
- [Form](/patterns/form) - the single-page structure that wizards fragment across steps
- [Progressive disclosure](/patterns/progressive-disclosure) - the conceptual foundation for revealing complexity gradually
- [Onboarding](/patterns/onboarding) - often employs wizards for initial setup and configuration
- [Step by step](/patterns/step-by-step) - Wizard is a specific implementation of the step by step navigation model, applying it to form-based tasks with validation and branching logic.

### Alternatives
- [Conversational form](/patterns/form#forms-and-conversation): Embeds form inputs within <ComponentRef id="actions-coordination-messaging--docs">messaging</ComponentRef> interface, allowing flexible dialogue whilst collecting structured data. Better for actors who benefit from clarifying questions.
- [Bot](/patterns/bot) - can guide through complex processes with conversational flexibility wizards lack

### Complementary
- [Status feedback](/patterns/status-feedback) - communicates progress and validation state throughout the wizard
- [Undo](/patterns/undo) - mitigates the high commitment level by allowing reversal of completed steps
