...
<ComponentRef id="components-messaging--docs">Messages</ComponentRef> or product <ComponentRef id="actions-sense-making-card--docs">cards</ComponentRef> can carry greater agency.
