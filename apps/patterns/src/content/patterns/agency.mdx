...
## Components
 ...
 - Autonomy,
 - [Adaptability](/patterns/adaptation)
 - Interactivity
...
See the [assistance](/patterns/assistance) and [delegation](/patterns/delegation) foundations for how coupling shapes the temporal flow.
...
>The six activity types describe *what kind of work is happening* in human-AI co-creation. They are close but not identical to modes of [assistance](/patterns/assistance).
...
Assistance—like [setting a default value](/patterns/good-defaults)—is probably the most typical example of agency on this level.
Primitives can also be dynamically arranged, selected, or shown based on context.
A [toolbar](/patterns/toolbar) might offer precisely relevant actions in response to user intent,
...
an interface and to actively guide the actor. [Explanations](/patterns/explanation), [suggestions](/patterns/suggestion), or [dynamically
arranged sections](/patterns/focus-and-context) respond proactively, anticipating needs and creating experiences that feel
...
- Cognitive engagement paradox: Whilst reducing mental effort seems beneficial, [appropriate cognitive](/patterns/conversation#question-driven-dialogue) load maintains higher perceived ownership, deeper elaboration, sustained skill development, and protection against [algorithmic loafing](/patterns/bot#anti-patterns).
...
- *Over-reliance* – accepting incorrect assistance — the user rubber-stamps output without catching errors, a failure mode that's especially dangerous when the system is confident but wrong. Over-reliance is the harder failure because users often can't tell they're doing it. See [cognitive forcing functions](/patterns/cognitive-forcing-functions) for patterns that deliberately create friction to prevent it.
...
- Relies on [adaptability](/patterns/adaptation)
- [Bot patterns](/patterns/bot) demonstrate different agency levels through interaction modes
