...
### Actions
<ComponentRef id="components-messaging--docs">Messages</ComponentRef> or product <ComponentRef id="components-card--docs">cards</ComponentRef> can carry greater agency.
...
- Cognitive engagement paradox: Whilst reducing mental effort seems beneficial, [appropriate cognitive](/patterns/conversation#question-driven-dialogue) load maintains higher perceived ownership, deeper elaboration, sustained skill development, and protection against [algorithmic loafing](/patterns/agent#anti-patterns).
