...
relationships:
  related:
    - to: adaptation
      note: adaptive behaviour shifts how much control the system takes on
    - learnability
---
...
At the foundation level, basic elements provide limited to no agency.
...
A <ComponentRef id="components-toolbar--docs">toolbar</ComponentRef> might offer precisely relevant actions in response to user intent,
