...
Investigate specific entities by progressively narrowing focus. Users navigate from collection overview through filtering to individual [item detail](/patterns/item-view), using <ComponentRef id="actions-evaluation-semantic-zoom--docs">semantic zoom</ComponentRef> to maintain spatial context.
