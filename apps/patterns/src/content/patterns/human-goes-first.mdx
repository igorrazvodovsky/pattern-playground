...
- [Cognitive forcing functions](/patterns/cognitive-forcing-functions) — the family this pattern belongs to
- Update after initial judgement — shares the "user judges first" structure but without the full skill-building arc
- [Learnability](/patterns/learnability) — domain learnability scaffolding that deepens rather than fades
- [Agency / appropriate reliance](/patterns/agency#appropriate-reliance) — directly prevents the skill atrophy side of over-reliance
