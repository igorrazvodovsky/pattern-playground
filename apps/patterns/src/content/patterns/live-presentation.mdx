...
- [Bot](/patterns/bot) — generates the stream that this surface presents in flight
...
- [Transparent reasoning](/patterns/transparent-reasoning) — its "stream of thought" mode rides on the same rendering substrate
