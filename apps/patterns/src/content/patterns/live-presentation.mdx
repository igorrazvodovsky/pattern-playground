...
situation:
  resulting:
    - clause: >-
        once the stream completes, a produced artifact sits on the surface — the
...
relationships:
  complements:
    ...
    - to: abort
      note: the user-side stop depends on the surface having a quiet resting state to land in
  enacts:
    - to: agency
