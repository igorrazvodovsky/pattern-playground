...
### Precursors
- [Agency](/patterns/agency) – settings implement actor control over system behaviour
- [Privacy](/patterns/privacy) – settings include visibility and access preferences
- [Adaptability](/patterns/adaptation) – settings enable system customization to context

### Complementary
- [Progressive disclosure](/patterns/progressive-disclosure) – manages complexity in extensive settings through hierarchical revelation
- [Form](/patterns/form) – settings are essentially configuration forms requiring similar patterns (validation, feedback, submission)
- [Wizard](/patterns/wizard) – may guide actors through initial settings configuration during setup
- [Onboarding](/patterns/onboarding) – settings can be introduced gradually during first-time experience
- [AI tuning](/patterns/ai-tuning) – specialized settings for configuring AI behaviour

### Follow-ups
- [Undo](/patterns/undo) – enables reversal of settings changes, particularly valuable for exploratory configuration
- [Status feedback](/patterns/status-feedback) – confirms settings changes and communicates their application
- [Notification](/patterns/notification) – alerts actors to settings-related changes, particularly in shared configuration contexts
- [Localization](/patterns/localization) — language, timezone, and format preferences feed locale configuration

### Tangentially related
- [Workspace](/patterns/workspace) – settings affect workspace behaviour and may be scoped to workspace contexts
- [Collaboration](/patterns/collaboration) – settings include collaboration preferences and affect shared work
