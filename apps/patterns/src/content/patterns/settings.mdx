...
relationships:
  precedes:
    - to: localization
      note: language, timezone, and format preferences
    - to: undo
      note: enables reversal of settings changes, particularly valuable for exploratory configuration
    - to: status-feedback
      note: confirms settings changes and communicates their application
    - to: notification
      note: alerts actors to settings-related changes, particularly in shared configuration contexts
  enacts:
    - to: agency
