...
- [Learnability](/patterns/learnability) – domain explanations support domain learnability
- [Disabled state](/patterns/state-disabled)
- [Progressive disclosure](/patterns/progressive-disclosure)
- [Transparent reasoning](/patterns/transparent-reasoning) – shows step-by-step process while explanation encourages understanding through interaction
- <ComponentRef id="primitives-popover--docs">Popover</ComponentRef>
- <ComponentRef id="components-drawer--docs">Drawer</ComponentRef>
- [Collaboration](/patterns/collaboration) – uses explanations to facilitate understanding through transparency about other actors' actions
- [Localization](/patterns/localization) — culturally appropriate explanation styles
