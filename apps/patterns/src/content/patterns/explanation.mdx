...
import { DynamicExplanationDemo } from '@pkg/demos/bubble-menu';
...
<Demo label="Dynamic explanation via bubble menu">
  <DynamicExplanationDemo client:only="react" />
</Demo>
...
Users can access the explanation <ComponentRef id="primitives-popover--docs">popover</ComponentRef> by clicking the explanation indicator. This popover offers contextual information beyond a single value and lists the factors that contributed to the result.
