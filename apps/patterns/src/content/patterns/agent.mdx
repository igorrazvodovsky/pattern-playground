...
relationships:
  ...
  precedes:
    ...
    - to: ai-tuning
      note: the agent's degree of freedom is a setting rather than a fixed property; tuning is the move that acts on it
    - to: onboarding
      note: the agent's capabilities and limits are the material a first encounter is designed to introduce
