...
<Demo name="item-view-glyph" surface="white" label="Glyph as map pin: the same entity the other rungs render, located among its population." />
...
<Demo name="reference" surface="white" label="Reference as @mention" />
...
<Demo name="item-view-row" label="Summary as table row" />
...
<Demo name="item-view-full" label="Full view" />
...
<Demo name="item-view-transitions" label="Fluid navigation up and down the ladder: hover the reference for its summary, then use the view-settings menu on any rung to move between summary (popover), detail (drawer) and full (dialog), in either direction." />
