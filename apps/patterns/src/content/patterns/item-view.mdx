...
An inline @mention that opens to richer detail on demand, rendered as a <ComponentRef id="primitives-reference--docs">reference</ComponentRef>:
...
- <ComponentRef id="actions-evaluation-semantic-zoom--docs">Semantic zoom</ComponentRef> - Density-preserving transitions between granularities
- <ComponentRef id="primitives-reference--docs">Reference</ComponentRef>
- <ComponentRef id="components-dialog--docs">Dialog</ComponentRef> & <ComponentRef id="components-drawer--docs">drawer</ComponentRef>
- <ComponentRef id="actions-sense-making-card--docs">Card</ComponentRef> – summary-level item representations
