...
<Demo surface="white" label="Glyph as map pin: the same entity the other rungs render, located among its population.">
...
<Demo surface="white" label="Reference as @mention">
