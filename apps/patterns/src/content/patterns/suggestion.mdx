...
- [Assistance](/patterns/assistance) — providing likely next actions and narrowing the option space
- [Delegation](/patterns/delegation) — agent might suggest opportunities it believes will help
- [Assisted task completion](/patterns/assisted-task-completion) — the completion spectrum, including [AI completion](/patterns/ai-completion) (inline generation) and [next-best action](/patterns/next-best-action) (workflow-level recommendations)
- [Adaptability](/patterns/adaptation) — suggestions might sharpen on the actor's accepted-or-rejected signal, fitting their patterns over time
- [Bot](/patterns/bot)
- <ComponentRef id="actions-coordination-messaging--docs">Messaging</ComponentRef>
- [Transparent reasoning](/patterns/transparent-reasoning) - suggestions can emerge from visible reasoning processes
- [Collaboration](/patterns/collaboration) - Suggestions support collaborative decision-making through AI-assisted discovery
- [Conversation](/patterns/conversation) - dialogue forms that provide alternatives to suggestion-based interaction
- [Formality](/patterns/formality) — suggestions ease the step from informal intent to formal expression, formalising by recognition rather than recall
- When suggestions carry real stakes, [cognitive forcing functions](/patterns/cognitive-forcing-functions) offer interventions that preserve the user's judgement.
