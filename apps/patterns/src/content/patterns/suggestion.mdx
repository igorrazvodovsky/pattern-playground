...
relationships:
  precedes:
    ...
    - to: next-best-action
      note: the broader pattern; next-best action is specifically about recommending workflow steps
    - prompt
  related:
    - to: assistance
      note: providing likely next actions and narrowing the option space
    - to: delegation
      note: agent might suggest opportunities it believes will help
    - ai-completion
    - to: transparent-reasoning
      note: suggestions can emerge from visible reasoning processes
  instances:
