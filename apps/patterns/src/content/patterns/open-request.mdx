...
- [Conversation](/patterns/conversation) — parent pattern; open request is the primary primitive for instruction-based dialogue
- [Opening (Bot)](/patterns/agent-opening) — bot-initiated openings typically transition into an open request
- [Opening (User)](/patterns/user-opening) — user-initiated openings with a complex request map directly to this primitive
- [Inquiry (Bot)](/patterns/inquiry-agent) — used within open request to gather missing or ambiguous constraints
