...
relationships:
  enables:
    - to: conversation
      note: parent pattern; open request is the primary primitive for instruction-based dialogue
  follows:
    - to: agent-opening
      note: bot-initiated openings typically transition into an open request
    - to: user-opening
      note: user-initiated openings with a complex request map directly to this primitive
  composed-of:
    - to: inquiry-agent
