...
- [Progressive disclosure](/patterns/progressive-disclosure) — link preview is the lightest disclosure tier: sample a destination before committing
...
- [Dynamic hyperlinks](/patterns/dynamic-hyperlinks) — inferred links benefit even more from preview, since actors have less prior expectation of where they lead
- [Annotation](/patterns/annotation) — previews can surface annotations and meta-layers attached to the target, enriching the probe
- [Deep linking](/patterns/deep-linking) — when a link targets a specific section, the preview can scroll to and highlight the anchored fragment

### Tangentially related

- [Learnability](/patterns/learnability) — previews help actors build a mental map of the knowledge base without navigating away from their current reading
- [Density](/patterns/density) — by deferring full content to hover, preview lets dense cross-referencing exist without overwhelming the page
