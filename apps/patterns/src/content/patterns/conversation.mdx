...
relationships:
  ...
  composed-of:
    ...
    - to: user-opening
      note: the actor speaks first and the bot aligns to their topic
    - to: capability-and-scope
      note: an explicit statement of what this exchange can and cannot do
    - to: inquiry-agent
  ...
  instances:
    ...
    - to: user-repair
      note: the actor signals the bot's last utterance didn't land
  enacts:
