...
- [Bot](/patterns/bot) – conversation partner
- [Prompt](/patterns/prompt) translates user needs into structured AI behavior within a conversation
- [Text lens](/patterns/text-lense) – filter lenses adapt conversational tone and style based on context and relationship
- *Conversation history* facilitates continuity, knowledge retention, and revisiting prior interactions
- [Collaboration](/patterns/collaboration) – uses conversation as a core communication mechanism for collaborative work
...
- All dialogue forms leverage [repair affordances](/patterns/agent-repair) and [sequence management](/patterns/sequence-completion) patterns to handle breakdowns and closures
- Encounters are framed by conversation management primitives — [opening (bot)](/patterns/agent-opening), [opening (user)](/patterns/user-opening), [capability & scope](/patterns/capability-and-scope), [closing](/patterns/closing), and [disengage without closing](/patterns/disengage-without-closing) — that structure the start, end, and interruption of encounters
