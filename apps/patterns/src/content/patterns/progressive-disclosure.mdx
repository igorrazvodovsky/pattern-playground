...
relationships:
  enables:
    ...
    - to: form
      note: revealing depth only as it becomes relevant.
    - to: bot
      note: bots reveal capability, intent, and reasoning incrementally, keeping early interactions simple while building actor confidence
  precedes:
    - to: wizard
      note: the conceptual foundation for revealing complexity gradually
  complements:
    - to: explanation
...
- <ComponentRef id="primitives-popover--docs">Popover</ComponentRef> — reveals supplementary information without an explicit expansion
