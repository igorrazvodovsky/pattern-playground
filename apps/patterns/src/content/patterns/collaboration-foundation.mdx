...
- [Conversation](/patterns/conversation-quality) — the foundational capability that enables effective collaboration
- [Agency](/patterns/agency) — the distribution of control and initiative between collaborative actors
- [Adaptability](/patterns/adaptation) — collaboration only works when each actor adjusts to the other's contributions in flight
- [Shareability](/patterns/shareability) — provides infrastructure for holopticism
- [Formality](/patterns/formality) — shared artefacts raise formality demands beyond what any single actor needs; the fidelity vs exploration tension is a formality tension
