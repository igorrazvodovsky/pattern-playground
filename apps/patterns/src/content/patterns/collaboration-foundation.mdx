...
title: Collaboration
role: foundation
fun: 🤯 4/5. Even before AI, collaboration features had become ubiquitous enough to warrant foundation-layer status. Agents just make the case stronger.
relationships:
  enacts:
    - to: agency
      note: control and initiative spread across the group, renegotiated as the work proceeds
    - to: adaptation
      note: collaboration only works when each actor adjusts to the other's contributions in flight
    - to: conversation-quality
      note: joint work is negotiated turn by turn; collaboration is dialogue put to a shared task
    - to: shareability
      note: each actor can see what the others are doing; shared work is visible work
    - to: formality
      note: shared artefacts raise formality demands beyond what any single actor needs; the fidelity vs exploration tension is a formality tension
    - to: privacy
      note: collaboration balances individual privacy needs against group transparency requirements
    - to: temporality
      note: whether the actors share time — synchronous and asynchronous modes give joint work different rhythms
---
...
Collaboration requires distributed [agency](/patterns/agency) and reciprocal [adaptability](/patterns/adaptation).
Actors continuously align their understanding of goals and coordinate their means.

Effective collaboration depends on [conversation](/patterns/conversation-quality) to build shared understanding and enable actors to surface goals, verify comprehension, and tune complexity through agreed protocols.
...
Managing these tensions requires deliberate design of conversational protocols and [agency](/patterns/agency) distribution.
...
The emergent ability of groups, whether composed of humans, or networks of humans and [agents](/patterns/agent), to solve problems, make decisions, or generate knowledge more effectively than individual actors alone.
...
CI conditions map to [collaboration stages](/patterns/collaboration#interaction-stages):
