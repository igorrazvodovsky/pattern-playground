...
- [Inquiry (User)](/patterns/inquiry-user) — transitions into information capture when a specific required value is missing
- [Sequence completion](/patterns/sequence-completion) — the primary activity resumes once repair is resolved
- [Capability & scope](/patterns/capability-and-scope) — out-of-scope requests are a form of scope repair
