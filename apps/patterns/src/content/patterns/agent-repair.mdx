...
situation:
  ...
  resulting:
    ...
    - clause: >-
        understanding is restored with the activity mid-flight, so completion has
        to be designed to resume at the step that broke rather than from the
        beginning — and still end in the receipt that closes the sequence
