...
- Risk of [algorithmic loafing](/patterns/bot#algorithmic-loafing)—reduced human effort when AI takes creative lead
...
See [Conversation](/patterns/conversation#dialogue-forms) for how dialogue forms shape elaboration in conversational interfaces, and [Bot](/patterns/bot) for interaction patterns that maintain engagement.
...
### Qualities
- [Agency](/patterns/agency) — agency is distributed, traded, and renegotiated turn by turn; human-centric locus tends to deepen elaboration, system-centric locus tends to surface acceptance

### Precursors
- [Collaboration](/patterns/collaboration-foundation) – the foundation this activity enacts
- [Conversation](/patterns/conversation) – how collaborators reach understanding and commitment
- [Bot](/patterns/bot) – frames the AI as a collaborator with its own modes
- [LLM Prompt](/patterns/prompt) – how humans address an AI participant

### Complementary
- [Activity log](/patterns/activity-log) – the shared record that lets participants reconstruct what happened
- [Notification](/patterns/notification) – signals what changed, by whom, and whether actor should look
- [Explanation](/patterns/explanation) – how participants understand each other's reasoning, not just each other's actions
- [Suggestion](/patterns/suggestion) – co-creation in tentative form: options participants can converge on or reject without commitment
- [Transparent reasoning](/patterns/transparent-reasoning) – makes the basis of decisions auditable
- [Command menu](/patterns/command-menu) – keeps collaboration commands accessible without crowding the surface
