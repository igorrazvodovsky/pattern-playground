...
---
Assistance is a configuration of [agency](/patterns/agency) where the locus is human-centric, coupling is tight, granularity is fine-grained, and dynamics are typically static. The human drives the [interaction arc](/patterns/interaction#how-engagement-unfolds-over-time); the system intervenes selectively at each cognitive step — raising a signal, explaining something, narrowing the options, supporting execution, or helping the user look back at what just happened.
...
{/* *Related patterns:* [Needs-based view](/patterns/dashboard) compresses state into a glanceable monitoring overview. [Activity feed](/patterns/activity-feed) keeps recent events visible as they accumulate. [Explanation](/patterns/explanation) extends into know territory when it surfaces what a signal means alongside the signal itself. */}
...
{/* [Explanation](/patterns/explanation) is the canonical know-assist pattern. */}
{/* [Transparent reasoning](/patterns/transparent-reasoning) makes the system's interpretive work visible. */}
{/* [AI completion](/patterns/ai-completion) can carry knowing assistance when it surfaces context inline with composition. */}
...
{/* [Suggestion](/patterns/suggestion) is the lightweight end of plan assistance — a next-likely action surfaced in context. */}
{/* [Next-best action](/patterns/next-best-action) extends this to proactive recommendation. */}
{/* [Assisted task completion](/patterns/assisted-task-completion) bridges plan and perform by guiding multi-step execution. */}
...
{/* [Assisted task completion](/patterns/assisted-task-completion) provides structured guidance during multi-step execution. */}
{/* [AI completion](/patterns/ai-completion) offers inline perform assistance in composition contexts, keeping the user as the author while reducing execution friction. */}
...
{/* [Activity log](/patterns/activity-log) provides the supervisory record that makes reflection possible. */}
{/* [Mastery](/patterns/mastery) supports the longer arc of skill development that sustained reflection enables. */}

## Enacted qualities & related foundations

- [Agency](/patterns/agency) — assistance keeps the locus human-centric: the actor stays in the loop and the system intervenes selectively, raising signals or narrowing options at each cognitive step rather than taking over
- Assistance sits on the [Intent & Interaction](/patterns/interaction) substrate and is the sibling configuration to [Delegation](/patterns/delegation)
