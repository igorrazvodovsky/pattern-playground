...
relationships:
  enacts:
    - to: agency
      note: "assistance keeps the locus human-centric: the actor stays in the loop and the system intervenes selectively, raising signals or narrowing options at each cognitive step rather than taking over"
  related:
    - interaction
    - delegation
  instances:
    - to: agent
      note: the chatbot and inline agent modes apply the assistance configuration
---
