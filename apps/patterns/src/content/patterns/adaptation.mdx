...
**Agency [spectrum](/patterns/agency#spectrum) mapping by confidence:**
...
Adjust system support based on user expertise and context. More guidance for novices (see [onboarding](/patterns/onboarding)), more autonomy for experts (see [mastery](/patterns/mastery)).
...
- Enables [agency](/patterns/agency) through dynamic control allocation
- Powers [bot](/patterns/bot) interactions via probabilistic responses
- Underlies [suggestion](/patterns/suggestion) and [explanation](/patterns/explanation) patterns
- [Localization](/patterns/localization) — exercises adaptability across linguistic and cultural boundaries
{/* - [Focus and context](/patterns/focus-and-context) */}
