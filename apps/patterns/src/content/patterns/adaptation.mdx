...
relationships:
  related:
    - to: agency
      note: dynamic control allocation distributes agency between system and user
---
...
{/* - Keep sources of action legible: if an agent or automation is acting, show what acted, why, and what can be undone. */}
