...
relationships:
  ...
  tangential:
    ...
    - to: interaction
      note: distinct but adjacent — the gesture grammar usually has to coexist with focus
...
<Demo name="select-all-affordance" surface="gray" label="Select-all with escalation to the matching set" />
...
<Demo name="mode-based-reveal" surface="gray" label="Mode-based reveal" />
