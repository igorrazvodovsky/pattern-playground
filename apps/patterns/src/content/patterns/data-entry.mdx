...
relationships:
  ...
  complements:
    - to: form
      note: 'a container for data entry: structured, multi-field, committed up front. [Conversation](/patterns/conversation) and the [inline interface](/patterns/inline-interface) are others.'
  alternative:
    - to: good-defaults
