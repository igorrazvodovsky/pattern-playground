...
- [Localization](/patterns/localization) — locale-aware input parsing and format tolerance
...
- [Form](/patterns/form) — a container for data entry: structured, multi-field, committed up front. [Conversation](/patterns/conversation) and the [inline interface](/patterns/inline-interface) are others.
- [Good defaults](/patterns/good-defaults) - use when you can make a good guess to avoid data entry entirely.
- [Status feedback](/patterns/status-feedback) - confirming the interpretation of forgiving input.
- [Bot](/patterns/bot) - the agent often responsible for interpreting forgiving input.
- [Transparent reasoning](/patterns/transparent-reasoning) - explaining *why* a specific interpretation was made.
- [Formality](/patterns/formality) — every data entry field is a choice about how formal the input has to be
