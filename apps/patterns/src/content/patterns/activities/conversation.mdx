...
- Question-driven dialogue chains [bot inquiry](/patterns/operations/conversation/conversational-activities/inquiry-agent) moves, where the bot asks questions to elicit human thinking
- Instruction-based dialogue typically begins with [open request](/patterns/operations/conversation/conversational-activities/open-request), where users make complex requests requiring clarification and multi-step execution
- All dialogue forms leverage [repair affordances](/patterns/operations/conversation/conversation-management/agent-repair) and [sequence management](/patterns/operations/conversation/sequence-management/sequence-completion) patterns to handle breakdowns and closures
- Encounters are framed by conversation management primitives — [opening (bot)](/patterns/operations/conversation/sequence-management/agent-opening), [opening (user)](/patterns/operations/conversation/sequence-management/user-opening), [capability & scope](/patterns/operations/conversation/conversation-management/capability-and-scope), [closing](/patterns/operations/conversation/sequence-management/closing), and [disengage without closing](/patterns/operations/conversation/conversation-management/disengage-without-closing) — that structure the start, end, and interruption of encounters
