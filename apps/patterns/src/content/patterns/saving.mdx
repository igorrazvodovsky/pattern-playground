...
<div>
- [Deletion](/patterns/deletion) – Save/cancel workflows as confirmation for destructive operations
- [Action consequences](/patterns/action-consequences) – Evaluating when save/cancel is appropriate
- Draft vs. publish workflow
- [Undo](/patterns/undo) – Reversibility in saved states
- Multiplayer
- [Collaboration](/patterns/collaboration) – Saving patterns handle conflict resolution and multi-user editing scenarios in shared workspaces
</div>