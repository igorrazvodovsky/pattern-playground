...
- [Extended telling](/patterns/extended-telling) — fallback when a simple paraphrase or definition is insufficient
- [Sequence completion](/patterns/sequence-completion) — the activity resumes from the same step once the repair is resolved
