...
### Complements
- [Collaboration](/patterns/collaboration) – provides broader collaborative context
- [Activity log](/patterns/activity-log) – tracks commenting activity over time
...
- [Status feedback](/patterns/status-feedback) – indicates comment and resolution states
