...
- [Closing](/patterns/operations/conversation/sequence-management/closing) — the preferred alternative when a formal close is possible
- [Opening (Bot)](/patterns/operations/conversation/sequence-management/agent-opening) — re-entry point when the bot resumes after a disengagement
- [Opening (User)](/patterns/operations/conversation/sequence-management/user-opening) — users can also re-open on their own initiative after stepping away
