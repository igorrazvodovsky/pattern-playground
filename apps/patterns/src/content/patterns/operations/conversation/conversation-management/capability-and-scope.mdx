...
- [Bot](/patterns/activities/bot) — the conversational partner whose capabilities are being stated
- [Opening (Bot)](/patterns/operations/conversation/sequence-management/agent-opening) — capability giving is often embedded within a bot-initiated opening
- [Bot repair](/patterns/operations/conversation/conversation-management/agent-repair) — out-of-scope or ambiguous requests are handled via bot repair
