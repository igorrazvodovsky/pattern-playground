...
- [Opening (Bot)](/patterns/operations/conversation/sequence-management/agent-opening) — offered as an alternative to immediate engagement on user refusal
- [User repair](/patterns/operations/conversation/conversation-management/user-repair) — extended telling is the fallback when simple paraphrase or definition fails to resolve confusion
