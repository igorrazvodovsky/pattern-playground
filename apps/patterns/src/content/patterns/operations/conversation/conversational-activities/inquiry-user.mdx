...
- [Bot repair](/patterns/operations/conversation/conversation-management/agent-repair) — information capture via this primitive is used to resolve bot-side ambiguity
- [Extended telling](/patterns/operations/conversation/conversational-activities/extended-telling) — for multi-part answers that exceed the scope of a single inquiry response
