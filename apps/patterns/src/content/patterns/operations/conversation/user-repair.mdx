...
- [Extended telling](/patterns/operations/conversation/extended-telling) — fallback when a simple paraphrase or definition is insufficient
- [Sequence completion](/patterns/operations/conversation/sequence-completion) — the activity resumes from the same step once the repair is resolved
