...
- [Conversation](/patterns/conversation) — parent pattern; extended telling is a primitive for instruction-based dialogue
- [Opening (Bot)](/patterns/agent-opening) — offered as an alternative to immediate engagement on user refusal
- [User repair](/patterns/user-repair) — extended telling is the fallback when simple paraphrase or definition fails to resolve confusion
