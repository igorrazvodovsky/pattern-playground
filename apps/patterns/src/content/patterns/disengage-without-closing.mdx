...
situation:
  ...
  resulting:
    - clause: >-
        the exchange is parked rather than ended: a saved state whose persistence
        the actor can see — material either opening now has to act on, re-entering
        with history rather than starting fresh
