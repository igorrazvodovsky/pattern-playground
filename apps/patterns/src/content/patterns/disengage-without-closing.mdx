...
- [Closing](/patterns/closing) — the preferred alternative when a formal close is possible
- [Opening (Bot)](/patterns/agent-opening) — re-entry point when the bot resumes after a disengagement
- [Opening (User)](/patterns/user-opening) — users can also re-open on their own initiative after stepping away
