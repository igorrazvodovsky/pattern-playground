...
export const productBinding: EntityBinding = {
  ...
  attributes: [
    ...
    { path: 'category', role: 'badge', valueType: 'string' },
    { path: 'subcategory', role: 'spec', valueType: 'string' },
    { path: 'condition', role: 'badge', valueType: 'string' },
    { path: 'pricing.msrp', label: 'Price', role: 'key-attribute', valueType: 'currency' },
    ...
    { path: 'availability.status', label: 'Availability', role: 'badge', valueType: 'status' },
    { path: 'availability.leadTime', label: 'Lead time', role: 'spec', valueType: 'number', unit: 'days' },
    { path: 'availability.regions', label: 'Regions', role: 'spec', valueType: 'string' },
    ...
    { path: 'lifecycle.repairability', label: 'Repairability', role: 'spec', valueType: 'string' },
    { path: 'lifecycle.upgradeability', label: 'Upgradeability', role: 'spec', valueType: 'string' },
    ...
    { path: 'sustainability.certifications', label: 'Certifications', role: 'spec', valueType: 'string' },
