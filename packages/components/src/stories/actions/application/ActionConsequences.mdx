...
<Meta
  title="Actions/Application/Action consequences"
...
- <PatternRef slug="actions/application/deletion">Deletion</PatternRef>
- [Saving](../?path=/docs/actions-application-saving--docs)
- <PatternRef slug="operations/undo">Undo</PatternRef>