...
import * as InlineConfirmationStories from '../../operations/InlineConfirmation.stories.tsx';
import * as DialogStories from '../../02-molecules/Dialog.stories.tsx';
import * as ToastStories from '../../01-atoms/Toast.stories.tsx';
...
This approach aligns with the [Saving](../?path=/docs/actions-application-saving--docs#save-cancel-as-confirmation-mechanism) pattern's hybrid model, providing a safety net while maintaining user control. It's particularly effective for:
...
- [Undo](../?path=/docs/operations-undo--docs)
- Soft delete: Items moved to archive; configurable retention period
- Version history

## Related patterns

- [Action consequences](../?path=/docs/actions-application-action-consequences--docs) – Framework for evaluating appropriate confirmation methods
- [Saving](../?path=/docs/actions-application-saving--docs) – Staged deletions within save/cancel workflows
- [Undo](../?path=/docs/operations-undo--docs) – Reversibility and recovery mechanisms
- [Status feedback](../?path=/docs/operations-status-feedback--docs) – Communicating deletion results
- [Activity Log](../?path=/docs/activities-activity-log--docs) – Historical record of deletions
- [Notification](../?path=/docs/actions-coordination-notification--docs) – Alerting about deletion events
- [Action bar](../?path=/docs/actions-coordination-action-bar--docs) – Common surface for bulk deletion
- [Selection](../?path=/docs/actions-coordination-selection--docs) – How the scope of a deletion gets staked
