...
- [Localization](/patterns/foundations/localization) — locale-aware input parsing and format tolerance
- [Input](../?path=/docs/primitives-input--docs) - the basic component used.
- [Select](../?path=/docs/primitives-select--docs) - picking one value from a short, bounded set when the actor already knows the answer.
...
- <PatternRef slug="activities/bot">Bot</PatternRef> - the agent often responsible for interpreting forgiving input.
- [Transparent reasoning](../?path=/docs/activities-transparent-reasoning--docs) - explaining *why* a specific interpretation was made.
- [Formality](/patterns/qualities/formality) — every data entry field is a choice about how formal the input has to be
