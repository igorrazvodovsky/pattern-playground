...
<Meta title="Actions/Application/Cognitive forcing functions/Checklist" tags={['activity-level:action', 'atomic:pattern', 'role:pattern', 'lifecycle:application', 'lifecycle:evaluation', 'mediation:individual']} />
