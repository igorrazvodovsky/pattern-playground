...
- Multiplayer
- [Collaboration](../?path=/docs/activities-collaboration--docs) – Saving patterns handle conflict resolution and multi-user editing scenarios in shared workspaces
</div>