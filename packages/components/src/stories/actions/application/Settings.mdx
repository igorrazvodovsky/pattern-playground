...
Settings implement [agency](/patterns/qualities/agency) through configuration control, respect [privacy](/patterns/qualities/privacy) through visibility and access preferences, and enable [adaptability](/patterns/qualities/adaptation) by allowing actors to shape system behaviour to their contexts.

## Behavioural position

Within the [Intent & Interaction framework](/patterns/foundations/interaction), settings operate across multiple behavioural categories depending on actor familiarity and intent.

### Navigating for experienced actors

When actors know exactly which setting they need, settings support efficient [navigating behaviour](/patterns/foundations/interaction#navigating). Clear organization, search functionality, and predictable structure enable direct access. Recent settings and favourites support swift re-finding.

### Exploring for discovery

New actors or those investigating available options engage in [exploring behaviour](/patterns/foundations/interaction#exploring). Progressive disclosure, logical grouping, and helpful descriptions support this discovery mode without overwhelming. Settings can serve as educational space—revealing capabilities through configuration options.

### Sense-making and integration

Settings facilitate [sense-making](/patterns/foundations/interaction#sense-making--integration) by organizing system capabilities into comprehensible structure. Actors build mental models of what's configurable and how different options relate. This understanding extends beyond immediate configuration tasks—settings documentation becomes reference material for understanding system behaviour.
...
Individual actor preferences visible and modifiable only by that actor. These implement [privacy](/patterns/qualities/privacy) through individual control and don't require coordination.
...
### Precursors
- [Agency](/patterns/qualities/agency) – settings implement actor control over system behaviour
- [Privacy](/patterns/qualities/privacy) – settings include visibility and access preferences
- [Adaptability](/patterns/qualities/adaptation) – settings enable system customization to context

### Complementary
- <PatternRef slug="actions/seeking/progressive-disclosure">Progressive disclosure</PatternRef> – manages complexity in extensive settings through hierarchical revelation
...
### Follow-ups
- <PatternRef slug="operations/undo">Undo</PatternRef> – enables reversal of settings changes, particularly valuable for exploratory configuration
...
- [Localization](/patterns/foundations/localization) — language, timezone, and format preferences feed locale configuration
...
- <PatternRef slug="activities/collaboration">Collaboration</PatternRef> – settings include collaboration preferences and affect shared work
