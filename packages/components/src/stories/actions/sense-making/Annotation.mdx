...
- [Badge](../?path=/docs/operations-badge--docs) – visual indicators used as status annotations.
...
- [Badge](../?path=/docs/operations-badge--docs) – visual annotation for status and categorical indicators
