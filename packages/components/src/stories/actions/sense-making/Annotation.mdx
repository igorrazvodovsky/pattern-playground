...
<Meta title="Actions/Sense-making/Annotation" tags={['activity-level:action', 'atomic:pattern', 'role:pattern', 'lifecycle:sense-making', 'mediation:individual']} />
...
### Follow-ups
- [Collaboration](../?path=/docs/activities-collaboration--docs) – shared annotations enable collaborative sense-making.
- [Conversation](../?path=/docs/activities-conversation--docs) – annotations often initiate critical dialogue.
- [Commenting](../?path=/docs/actions-coordination-commenting--docs) – extends static annotation into dynamic discussion.

### Complementary
- [Explanation](../?path=/docs/actions-sensemaking-explanation--docs) – clarifies complex concepts, often via description.
- [Transparent reasoning](../?path=/docs/activities-transparent-reasoning--docs) – system annotations that reveal decision logic.
- [Generated content](../?path=/docs/activities-generated-content--docs) – system marks confidence and origin.
- [Reference](../?path=/docs/concepts-reference--docs) – citation and source tracking.
- [Tag](../?path=/docs/actions-sensemaking-tag--docs) – semantic tagging for organisation.
...
{/*
### Content enhancement
- [Explanation](../?path=/docs/actions-sensemaking-explanation--docs) – annotations that clarify complex concepts
- [Generated content](../?path=/docs/activities-generated-content--docs) – system annotations showing confidence and reasoning
- [Transparent reasoning](../?path=/docs/activities-transparent-reasoning--docs) – algorithmic annotations revealing decision logic

### Sense-making support
- [Reference](../?path=/docs/concepts-reference--docs) – citation and source tracking through annotation
- [Tag](../?path=/docs/actions-sensemaking-tag--docs) – semantic tagging for taxonomic classification and organisation
- [Badge](../?path=/docs/primitives-badge--docs) – visual annotation for status and categorical indicators

### Behavioural connections
Per the [Intent & Interaction framework](/patterns/foundations/interaction):
