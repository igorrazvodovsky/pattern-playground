...
<Story of={BubbleMenuStories.DynamicExplanation} />
...
- <PatternRef slug="activities/collaboration">Collaboration</PatternRef> – uses explanations to facilitate understanding through transparency about other actors' actions
