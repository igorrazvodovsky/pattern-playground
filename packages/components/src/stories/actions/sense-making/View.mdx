...
- [Malleability](/patterns/malleability) - The capability to change the view's content, layout, and composition
- [Semantic zoom](../?path=/docs/actions-application-semantic-zoom--docs) - Density-preserving transitions between framings
- <PatternRef slug="progressive-disclosure">Progressive disclosure</PatternRef> - Sequential revelation of information
- [Density](/patterns/density) - Information per unit of space
- [Adaptability](/patterns/adaptation) - System response to context changes
