...
### Complements
- <PatternRef slug="deep-linking">Deep linking</PatternRef> — sharing and bookmarking items
- Progress tracking and resume features
- Image loading optimisation (lazy loading)
- Breadcrumbs showing hub context

### Alternatives
- [Hybrid with filtering](/patterns/filtering) for large collections
- [Step by step](/patterns/step-by-step) for strict sequences
- [Multilevel tree](/patterns/multilevel-tree) for hierarchical content
- [Hub and spoke](/patterns/hub-and-spoke) when items don't form sequences
