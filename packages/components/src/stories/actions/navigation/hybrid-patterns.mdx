...
<PatternRef slug="wizard">Wizard</PatternRef> is pure step by step—strict sequence, no jumping. This hybrid relaxes that constraint.
...
- [Navigation models](/patterns/navigation-overview)
- [Information architecture](/patterns/information-architecture) — conceptual framework
- [Agency](/patterns/agency) — control implications of combinations
