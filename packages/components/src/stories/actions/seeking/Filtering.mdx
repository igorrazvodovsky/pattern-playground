...
If that fails, users can delegate filtering to a <PatternRef slug="bot">bot</PatternRef> via a [task](../?path=/docs/concepts-task--docs). Bot can have access to data beyond the attributes and values visible to the user.
