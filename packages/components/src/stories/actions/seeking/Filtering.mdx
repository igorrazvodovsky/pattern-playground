...
If that fails, users can delegate filtering to a [bot](../?path=/docs/activities-bot--docs) via a [task](../?path=/docs/concepts-task--docs). Bot can have access to data beyond the attributes and values visible to the user.
