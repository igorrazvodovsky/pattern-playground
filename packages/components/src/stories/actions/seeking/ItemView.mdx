...
<Meta title="Actions/Seeking/Item view" of = { ItemViewStories } tags={['activity-level:action', 'atomic:composition', 'role:pattern', 'lifecycle:seeking', 'mediation:individual']} />
