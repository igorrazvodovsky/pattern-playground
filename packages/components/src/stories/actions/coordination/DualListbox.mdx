...
- [Action bar](../?path=/docs/components-action-bar--docs) — the immediate-action alternative; when "assign these to that" is a bulk action on an existing selection without a review step, an action bar suffices
