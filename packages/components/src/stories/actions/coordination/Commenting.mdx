...
import {Commenting} from '../../02-molecules/BubbleMenu.stories';
...
{/* **Precursors:** */}
{/* - [Annotation](../?path=/docs/actions-sensemaking-annotation--docs) – establishes content marking concepts */}

### Complements
- [Collaboration](../?path=/docs/activities-collaboration--docs) – provides broader collaborative context
