...
import {Commenting} from '../../BubbleMenu.stories';

{/* > 🙂 **Fun meter: 3/5**. Dependency. */}

<Meta title="Actions/Coordination/Commenting" tags={['activity-level:action', 'atomic:composition', 'role:pattern', 'lifecycle:coordination', 'mediation:coordination']} />
...
{/* **Precursors:** */}
{/* - <PatternRef slug="actions/sense-making/annotation">Annotation</PatternRef> – establishes content marking concepts */}

### Complements
- <PatternRef slug="activities/collaboration">Collaboration</PatternRef> – provides broader collaborative context
- <PatternRef slug="activities/activity-log">Activity log</PatternRef> – tracks commenting activity over time
- [Notification](../?path=/docs/actions-coordination-notification--docs) – alerts users to comment activity
...
- [Conversation](../?path=/docs/activities-conversation--docs) – provides dialogue interaction principles
- <PatternRef slug="operations/status-feedback">Status feedback</PatternRef> – indicates comment and resolution states
