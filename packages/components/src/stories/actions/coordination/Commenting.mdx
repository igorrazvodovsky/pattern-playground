...
{/* **Precursors:** */}
{/* - <PatternRef slug="annotation">Annotation</PatternRef> – establishes content marking concepts */}

### Complements
- <PatternRef slug="collaboration">Collaboration</PatternRef> – provides broader collaborative context
- <PatternRef slug="activity-log">Activity log</PatternRef> – tracks commenting activity over time
- [Notification](/patterns/notification) – alerts users to comment activity
...
- [Conversation](/patterns/conversation) – provides dialogue interaction principles
- <PatternRef slug="status-feedback">Status feedback</PatternRef> – indicates comment and resolution states
