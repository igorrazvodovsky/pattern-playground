...
import { DisruptiveNotification as Dialog } from '../../Dialog.stories';
import { Notification as Toast } from '../../Toast.stories';
...
The delivery of system events to the actor's attention, balancing awareness against interruption. As one of three ways to give <PatternRef slug="operations/status-feedback">status feedback</PatternRef>, every notification has three parts: *purpose*, *type*, and *scope*.
...
- Part of the <PatternRef slug="operations/status-feedback">status feedback</PatternRef> pattern system
- Complementary to validation and indication approaches
- <PatternRef slug="activities/collaboration">Collaboration</PatternRef> – Notifications keep collaborators informed of changes and events in shared environments
