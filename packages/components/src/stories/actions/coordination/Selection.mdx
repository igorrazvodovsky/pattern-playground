...
- <PatternRef slug="tag">Tag</PatternRef>, <PatternRef slug="grouping">Grouping</PatternRef> — common payloads of bulk action
...
- [Data view](/patterns/data-view), [Card](../?path=/docs/actions-sense-making-card--docs) — the views in which item selection happens
