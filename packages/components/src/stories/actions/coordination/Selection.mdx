...
- <PatternRef slug="actions/application/deletion">Deletion</PatternRef> — the most common operation routed through selection; confirmation strategy should scale with the selection count
- <PatternRef slug="actions/sense-making/tag">Tag</PatternRef>, [Grouping](../?path=/docs/actions-sensemaking-grouping--docs) — common payloads of bulk action
...
- <PatternRef slug="actions/seeking/searching">Searching</PatternRef> — Search shrinks the population from which selections are drawn
...
- [Focus](/patterns/foundations/interaction) — distinct but adjacent; the gesture grammar usually has to coexist with focus
