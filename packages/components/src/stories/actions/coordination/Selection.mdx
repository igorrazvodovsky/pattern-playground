...
- [Action bar](../?path=/docs/components-action-bar--docs) — the primary consumer of multi-item selection; its existence is conditional on a selection existing
- [Bubble menu](../?path=/docs/components-bubble-menu--docs) — the primary consumer of content-range selection; spatially anchored to the selection
- [Context menu](../?path=/docs/components-context-menu--docs) — degenerate-case consumer; pointer-invoked on a single target
- <PatternRef slug="deletion">Deletion</PatternRef> — the most common operation routed through selection; confirmation strategy should scale with the selection count
- <PatternRef slug="tag">Tag</PatternRef>, [Grouping](../?path=/docs/actions-sensemaking-grouping--docs) — common payloads of bulk action
...
- <PatternRef slug="searching">Searching</PatternRef> — Search shrinks the population from which selections are drawn
...
- [Checkbox](../?path=/docs/primitives-checkbox--docs) — the most explicit selection affordance
- [Focus](/patterns/interaction) — distinct but adjacent; the gesture grammar usually has to coexist with focus

### Containers

- [Data view](/patterns/data-view), [Card](../?path=/docs/actions-sensemaking-card--docs) — the views in which item selection happens
- [Block-based editor](../?path=/docs/components-blockbased-editor--docs) — the surface in which content selection happens
