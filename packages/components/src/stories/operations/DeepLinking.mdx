...
<Meta title="Operations/Deep linking" tags={['activity-level:operation', 'atomic:primitive', 'role:pattern', 'mediation:individual']} />
...
- [Messaging](../?path=/docs/actions-coordination-messaging--docs) — Each message/thread is addressable
- [Commenting](../?path=/docs/actions-coordination-commenting--docs) — Comments get unique URLs
- <PatternRef slug="actions/seeking/progressive-disclosure">Progressive disclosure</PatternRef> — URL state tracks what's expanded/revealed
