...
- <PatternRef slug="actions/seeking/searching">Searching</PatternRef> — the entry phase of instant-results search (popover or dropdown variant) follows the combobox model
