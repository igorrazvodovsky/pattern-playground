...
<Meta title="Operations/Conversation/Conversational activities/Extended telling" tags={['activity-level:operation', 'atomic:primitive', 'role:pattern', 'mediation:coordination']} />
