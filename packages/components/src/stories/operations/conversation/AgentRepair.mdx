...
<Meta title="Operations/Conversation/Sequence management/Bot repair" tags={['activity-level:operation', 'atomic:primitive', 'role:pattern', 'mediation:coordination']} />
...
- [Inquiry (User)](../?path=/docs/operations-conversation-conversational-activities-inquiry-user--docs) — transitions into information capture when a specific required value is missing
- [Sequence completion](../?path=/docs/operations-conversation-sequence-management-sequence-completion--docs) — the primary activity resumes once repair is resolved
- [Capability & scope](../?path=/docs/operations-conversation-conversation-management-capability-scope--docs) — out-of-scope requests are a form of scope repair
