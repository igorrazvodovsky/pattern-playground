...
- [Checkbox](../?path=/docs/operations-checkbox--docs) — same binary-state input, different commit timing
- [Button](../?path=/docs/operations-button--docs) — for one-shot actions where state isn't carried forward
