...
`TODO:` Use `multiple` with [tags](../?path=/docs/components-tag--docs) for multi-select behavior.
...
- [Input](../?path=/docs/components-input--docs) — the text field half of the contract, without the popup
- [Select](../?path=/docs/components-select--docs) — the simpler counterpart for short, bounded sets already known to the actor
