...
Controlling the [density](/patterns/qualities/density#information-density) of a GUI through dynamic, user-driven transformations of information representation: showing different types and amounts of information at different scales.

Within the [view](/patterns/foundations/view-system) system, semantic zoom enables fluid transitions across framing dimensions while preserving spatial context.
...
- [View](/patterns/foundations/view-system) - Conceptual framework for need-driven data framings
