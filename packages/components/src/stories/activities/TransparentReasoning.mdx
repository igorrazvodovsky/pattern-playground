...
- [Cognitive forcing functions](../?path=/docs/actions-application-cognitive-forcing-functions--docs) — counterbalancing interventions when transparent reasoning slides into over-reliance
