...
- Delivery mechanisms: <PatternRef slug="help">guided tours and overlays</PatternRef> introduce features without requiring pedagogic commands.
...
- *Enable <PatternRef slug="activity-log">archaeology</PatternRef>:* Let users trace how things came to be—history, authorship, related changes
...
### Precursors
- [Learnability](/patterns/learnability) – the foundation supporting value demonstration.
- [Empty state](/patterns/state-empty) — often the canvas for onboarding and as such an enabler for it

### Follow-ups
- <PatternRef slug="mastery">Mastery</PatternRef> – building proficiency after initial learning.

### Complementary
- <PatternRef slug="help">Help</PatternRef> – provides just-in-time assistance.
- [Localization](/patterns/localization) — first-run locale detection and selection
