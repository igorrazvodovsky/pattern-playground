...
<Meta title="Primitives/Range" of={RangeStories} tags={['activity-level:operation', 'atomic:primitive', 'role:component', 'mediation:individual']} />
...
### Related primitives
- [Input](../?path=/docs/primitives-input--docs) — typed numeric entry when the actor already knows the exact value.
- [Counter](../?path=/docs/primitives-counter--docs) — announces the numeric state a slider changes; useful as a passive readout alongside direct manipulation.
