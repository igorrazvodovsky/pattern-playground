...
- [Morphing controls](/patterns/morphing-controls) — when each state needs a distinct label or affordance (Follow/Unfollow, Start/Stop), a morphing control is the better fit
