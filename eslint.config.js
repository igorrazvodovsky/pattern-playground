...
// See Storybook `Foundations/Figures` and plans/*/2026-07-figures.md.
const figuresRules = [
  {
    selector: "CallExpression[callee.property.name=/^toLocale(Date|Time)?String$/]",
    message: 'Format through @shared/format, not toLocale*. See Foundations/Figures.',
  },
  {
    selector: "NewExpression[callee.object.name='Intl'][callee.property.name=/^(DateTimeFormat|NumberFormat|RelativeTimeFormat)$/]",
    message: 'Construct Intl formatters in @shared/format, where they are memoised. See Foundations/Figures.',
  },
];
...
export default [
  ...
  },
  {
    ...
    rules: {
      'no-restricted-syntax': ['error', ...figuresRules],
    },
  },
  {
