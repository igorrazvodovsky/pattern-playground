...
- *4 inline `style` prop eslint-disables* — `CommentComposer.tsx` (flex layout), `OnCanvasComponentPicker.tsx` (dynamic width). Added 2026-04-12. `Sidebar.tsx` (2×, CSS variable scoping for `--sidebar-width` / `--sidebar-width-icon`). Added 2026-05-15.
