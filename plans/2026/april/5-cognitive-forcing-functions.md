...
- `plans/2026/april/interaction-see-think-do-reframe.md` — introduces the attended/delegated framing used in the umbrella
- `plans/2026/april/agency-attentional-coupling.md` — introduces the appropriate-reliance concept the umbrella anchors on
