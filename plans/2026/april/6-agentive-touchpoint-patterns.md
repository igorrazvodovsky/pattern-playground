...
[`2-delegation-foundation.md`](./2-delegation-foundation.md) names ~25 touchpoints from Noessel's inventory and maps them to the existing pattern library. The mapping found two kinds of gap:
...
- [`2-delegation-foundation.md`](./2-delegation-foundation.md) — the foundation this plan supports
