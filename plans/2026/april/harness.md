...
### `plans/index.md`
For each plan file: one line — `- [title](relative/path.md) — status: active|paused|merged|archived`. Group by:
- *Active* — `2026/april/` and the still-relevant items from `2026/march/`
- *Recent* — older 2026 items and 2025 items not yet archived
- *Archived* — `archive/` contents
...
- The Activity Theory reorganisation itself — that work continues in `plans/2026/march/activity-theory-reorg.md`; this refactor only documents the *current* state of the migration accurately
