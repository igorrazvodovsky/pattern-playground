...
The framing parallels [`delegation-foundation.md`](./delegation-foundation.md), which creates Delegation.mdx for the agent-mode counterpart. Both refine the see-think-do substrate established in [`interaction-see-think-do-reframe.md`](./interaction-see-think-do-reframe.md). Three foundations, one substrate, two refinements.
...
- Plans this one interacts with:
  ...
  - `plans/2026/april/delegation-foundation.md` (sibling foundation)
  - `plans/2026/april/agency-attentional-coupling.md` (relationship to coupling and to Wu/Zhang's activity types)
  - `plans/2026/april/cognitive-forcing-functions.md` (forward link to interventions on failed assistance)
