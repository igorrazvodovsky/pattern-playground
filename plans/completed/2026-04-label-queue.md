...
|---|---|---|---|
| [label-axis-flagged.md](./2026-04-label-axis-flagged.md) | `axis-flagged` | 3 | Judgement — confirm the type or propose a different one |
| [label-thematic.md](./2026-04-label-thematic.md) | `thematic` | 45 | Partial research — surface any further promotion candidates, then label |
| [label-enacts.md](./2026-04-label-enacts.md) | `enacts` | 89 | Authoring — one sentence per edge, batched by source pattern |
