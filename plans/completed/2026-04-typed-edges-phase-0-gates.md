...
Working notes from the Phase 0 gates of [typed-edges.md](./2026-04-typed-edges.md). The vocabulary changelog at [relationship-vocabulary.md](../../docs/language/relationship-vocabulary.md) records the decisions; this file keeps the deliberation that produced them.
