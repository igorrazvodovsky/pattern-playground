---
title: "Create Delegation.mdx as a foundation"
status: "active"
kind: "exec-spec"
created: "2026-04"
last_reviewed: "2026-05-01"
area: "language"
promoted_to: "none — content is the residue (the delegation foundation page)"
superseded_by: ""
---
...
This plan parallels [`assistance-foundation.md`](./2026-04-assistance-foundation.md) for the assistant-mode counterpart and depends on [`interaction-see-think-do-reframe.md`](./2026-04-interaction-see-think-do-reframe.md) for the substrate vocabulary it builds on.
...
The "Existing pattern" column records whether the library already has a home for the touchpoint (good / partial / missing). See [`6-agentive-touchpoint-patterns.md`](./2026-04-agentive-touchpoint-patterns.md) for the follow-up plan that closes the missing-pattern gaps.
...
The "conversation-scoped, needs an agentive counterpart" patterns are flagged in the follow-up plan ([`6-agentive-touchpoint-patterns.md`](./2026-04-agentive-touchpoint-patterns.md)) as candidates for either generalisation or paired delegation-mode patterns.
...
- Plans this one interacts with:
  ...
  - `plans/active/2026-04-assistance-foundation.md` (sibling foundation)
  - `plans/active/2026-04-agency-attentional-coupling.md` (relationship to coupling, trust, appropriate reliance)
