---
title: "Add attentional coupling and appropriate reliance to Agency.mdx"
status: "active"
kind: "exec-spec"
created: "2026-04"
...
The cross-reference to `cognitive forcing functions` is a forward reference to the pattern family created in `plans/active/2026-04-cognitive-forcing-functions.md`. It's explicit here because that's the natural upstream anchor for those patterns.
...
- Plans this one interacts with:
  - `plans/active/2026-04-interaction-see-think-do-reframe.md`
